...
$(BUILD_DIR)/MPDTable.bin : $(MICROCODE_DIR)/MPDTable.asm $(MICROCODE_DIR)/Microcode.mak
	ml /nologo /c /Cx /W3 /WX /IBuild /DMKF_MICROCODE_ALIGNMENT=$(MICROCODE_ALIGNMENT) /Fo$(BUILD_DIR)/MPDTable.obj  $(MICROCODE_DIR)/MPDTable.asm
...
$(BUILD_DIR)/MPDTableBB.bin : $(MICROCODE_DIR)/MPDTableBB.asm $(MICROCODE_DIR)/Microcode.mak
	ml /nologo /c /Cx /W3 /WX /IBuild /DMKF_MICROCODE_ALIGNMENT=$(MICROCODE_ALIGNMENT) /Fo$(BUILD_DIR)/MPDTableBB.obj  $(MICROCODE_DIR)/MPDTableBB.asm
