...
//
// AMI PORTING START.- Assert in IScsi Attempt Name
//
#define ATTEMPT_NAME_MAX_SIZE         97
#define ATTEMPT_NAME_IFR_MAX_SIZE     96
//
// AMI PORTING END.- Assert in IScsi Attempt Name
//
...
#define IP_INIT_IP_DISPLAY_SIZE   54  // AMI Porting - Display initiator IP when DHCP is enabled
...
// AMI PORTING START.
//
#define ISID_CONFIGURABLE_MAX_LEN 6
#define ISID_CONFIGURABLE_STORAGE 7 // This value should be (ISID_CONFIGURABLE_MAX_LEN+1)
//
// AMI PORTING END.
//
...
typedef struct _ISCSI_CONFIG_IFR_NVDATA {
  ...
  //
  // AMI PORTING : Flag added to gray out setup options Add Attempt, Delete Attempt and Change Attempt Order when iscsi name is not valid.
  //
  BOOLEAN IsInitiatorNameValid;
  UINT8 SystemAccessVar;
  //
  // AMI PORTING : Variable created for getting admin/user privileges
  //
