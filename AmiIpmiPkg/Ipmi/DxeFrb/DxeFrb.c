  ...
  IN EFI_SYSTEM_TABLE     *SystemTable )
{
    ...
    UINTN                                   Size;
    EFI_GUID                                guidEfiShellEnvironment2Guid = SHELL_ENVIRONMENT_PROTOCOL_GUID;
    ...
    if ( ( gServerMgmtConfiguration.OsBootWdtEnable ) ) {
        //
        // Register Event for Shell environment guid to disable OS Wdt Timer before booting to Shell.
        //
        EfiNamedEventListen (
          &guidEfiShellEnvironment2Guid,
          TPL_NOTIFY,
