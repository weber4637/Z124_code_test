        ...
        for (i = 1; !EFI_ERROR(Status); i++){
            ...
            if (!EFI_ERROR(Status)){
              ...
              if (Type17->StructureType.Handle == EventHandle){
                ...
                FreePool( Structure); // Denverton AptioV Override - EIP#501277
                Found = TRUE;
                break;
              }
...
// Don't save tokens for custom strings.
  ...
  FreePool(TempBuffer); // Denverton AptioV Override - EIP#501277
...
// Free the Handle buffer
    ...
    if (HandleBuffer != NULL) {
        FreePool (HandleBuffer); // Denverton AptioV Override - EIP#501277
    }
