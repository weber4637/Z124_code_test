...
# if 0                               // To resolve build error for openssl-1.1.0
//APTIOV OVERRIDE ends
#  ifdef __DJGPP__
#   include <unistd.h>
//#   include <sys/stat.h>   //APTIOV OVERRIDE - To avoid build error for Openssl_1.1.1b
...
#   endif
//#   include <malloc.h>  //APTIOV OVERRIDE - To avoid build error for Openssl_1.1.1b
...
//#   include <sys/times.h>  //APTIOV OVERRIDE - To avoid build error for Openssl_1.1.1b
#  else
#   include <sys/time.h>
#  endif
