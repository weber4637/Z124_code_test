...
#endif
//#define OPENSSL_MIN_API 0x10100000L - APTIOV OVERRIDE To avoid build error
...
#endif
//APTIOV OVERRIDE for Http module
...
#endif
//#ifndef OPENSSL_NO_STDIO   //APTIOV OVERRIDE using build option to control
