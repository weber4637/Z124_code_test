...
static char *dl_merger(DSO *dso, const char *filespec1, const char *filespec2)
{
         ...
         */
    {
        ...
        AsciiStrCpyS(merged, (len + 2), filespec2);  //APTIOV Override to avoid buffer overlap assert.
        merged[spec2len] = '/';
        AsciiStrCpyS(&merged[spec2len + 1], (len + 2 - spec2len), filespec1);  //APTIOV Override to avoid buffer overlap assert.
    }
    return merged;
}
