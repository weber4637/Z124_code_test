...
#include <openssl/x509.h>	//APTIOV OVERRIDE - To resolve build error for openssl-1.1.0
#include <openssl/x509v3.h>	//APTIOV OVERRIDE - To resolve build error for openssl-1.1.0
