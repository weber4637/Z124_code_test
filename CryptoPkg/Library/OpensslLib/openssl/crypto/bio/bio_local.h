...
//APTIOV OVERRIDE starts - for build error 1.1.0
struct in_addr {
...
//APTIOV OVERRIDE ends - for build error 1.1.0
//APTIOV OVERRIDE starts - for build error 1.1.1d
struct in6_addr {
...
# endif
# ifdef HEADER_BIO_H
//#  error openssl/bio.h included before bio_lcl.h	 //APTIOV OVERRIDE
# endif
...
typedef unsigned int socklen_t;	//APTIOV OVERRIDE - for build error 1.1.0
