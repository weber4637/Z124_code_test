...
#include "internal/dso_conf.h" //APTIOV Override - To avoid build error as 
                               //dso_conf.h is defined under internal path.
...
# if defined(DSO_WIN32) && !defined(_WIN32_WCE)
        {
            // APTIOV OVERRIDE starts - To resolve unsued variable "handlersym" GCC warning.
            union {
                void *sym;
                void (*func)(void);
            } handlersym;
...
# elif !defined(DSO_NONE)
         ...
         */
        {
            ...
            handlersym.func = handler;
            // APTIOV OVERRIDE ends - To resolve unsued variable "handlersym" GCC warning.
