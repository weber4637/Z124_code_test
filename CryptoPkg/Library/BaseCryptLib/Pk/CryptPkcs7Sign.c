...
#include <openssl/evp.h>		//APTIOV OVERRIDE - To avoid build error for Openssl-1.1.0
#include <crypto/evp.h>	        //APTIOV OVERRIDE - To avoid build error for Openssl-1.1.0
  ...
  )
{
  ...
  P7Data     = local_malloc (P7DataSize); //APTIOV OVERRIDE - To avoid redefinition build error 
