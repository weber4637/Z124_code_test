...
STATIC CONST TLS_CIPHER_MAPPING TlsCipherMappingTable[] = {
  ...
  MAP ( 0xC02F, "ECDHE-RSA-AES128-GCM-SHA256" ),    /// TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256 - APTIOV OVERRIDE
  MAP ( 0xC030, "ECDHE-RSA-AES256-GCM-SHA384" ),    /// TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 - APTIOV OVERRIDE
  MAP ( 0xCCA8, "ECDHE-RSA-CHACHA20-POLY1305" ),    /// TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256 - APTIOV OVERRIDE
...
STATIC CONST TLS_CIPHER_PAIR TlsCipherMappingTable[] = {
  ...
  { 0xC02F, "ECDHE-RSA-AES128-GCM-SHA256" },    /// TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256
  { 0xC030, "ECDHE-RSA-AES256-GCM-SHA384" },     /// TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384
  { 0xCCA8, "ECDHE-RSA-CHACHA20-POLY1305" },     /// TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256
};
...
{
//APTIOV OVERRIDE starts - Added TlsSetHostPrivateKey to support KMIP server implementation
    BIO             *in;
    EVP_PKEY        *pkey = NULL;
    TLS_CONNECTION  *TlsConn;
    SSL_CTX         *ctx;
    ...
    BIO_puts (in, Data);
    // Retrieve Private Key from encrypted PEM data
    ...
    return EFI_SUCCESS;
//APTIOV OVERRIDE ends - Added TlsSetHostPrivateKey to support KMIP server implementation
}
