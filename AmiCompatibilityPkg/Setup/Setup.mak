...
ifneq ($(SETUP_DEFINITIONS),"")
	@$(ECHO) \
"  $(patsubst %,../%,$(subst $(SPACE),$(EOL)$(SPACE),$(subst \,/,$(SETUP_DEFINITIONS))))$(EOL)\
">> $(BUILD_DIR)/Setup.inf
endif
ifneq ($(SetupStringFiles),"")
	@$(ECHO) \
"  $(patsubst %,../%,$(subst $(SPACE),$(EOL)$(SPACE),$(subst \,/,$(SetupStringFiles))))$(EOL)\
">> $(BUILD_DIR)/Setup.inf
endif
ifneq ($(SetupCallbackFiles),"")
	@$(ECHO) \
"	$(patsubst %,../%,$(subst $(SPACE),$(EOL)$(SPACE),$(subst \,/,$(SetupCallbackFiles))))$(EOL)\
">> $(BUILD_DIR)/Setup.inf
endif
	@$(ECHO) \
"$(EOL)\
