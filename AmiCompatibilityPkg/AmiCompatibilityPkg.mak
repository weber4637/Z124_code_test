...
#G160-002(11)   	$(ECHO) \
#G160-002(11)   "#pragma pack(1)$(EOL)\
#G160-002(11)   typedef struct{$(EOL)\
#G160-002(11)     UINT8 Numlock;$(EOL)\
#G160-002(11)     #define SETUP_DATA_DEFINITION$(EOL)\
#G160-002(11)     #include <SetupDefinitions.h>$(EOL)\
#G160-002(11)     #undef SETUP_DATA_DEFINITION$(EOL)\
#G160-002(11)   } SETUP_DATA;$(EOL)\
#G160-002(11)   #pragma pack()$(EOL)"\
#G160-002(11)   >$(BUILD_DIR)/GenericSetupDataDefinition.h
...
typedef struct{$(EOL)\
  UINT8 Numlock;$(EOL)\
  UINT8 NEXCOM_MINI_PCIE1;$(EOL)\
  UINT8 NEXCOM_MINI_PCIE2;$(EOL)\
  UINT8 NEXCOM_4G_LTE;$(EOL)\
