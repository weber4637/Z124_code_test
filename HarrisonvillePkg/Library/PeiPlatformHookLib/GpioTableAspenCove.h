...
#ifndef GPIOTABLEASPENCOVE_H_
#define GPIOTABLEASPENCOVE_H_
static GPIO_INIT_CONFIG mAspenCoveCfioInitTable [] = {
// GBE0_SDP0 (GPIO_14)
{ NORTH_ALL_GBE0_SDP0           , {GpioPadModeNative1  , GpioHostOwnGpio, GpioDirNone  , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
// GBE1_SDP0 (GPIO_15)
{ NORTH_ALL_GBE1_SDP0           , {GpioPadModeNative1  , GpioHostOwnGpio, GpioDirNone  , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
// SPARE (GPIO_16)
...
// SPARE (Pin strap) (GPIO_21)
{ NORTH_ALL_GBE1_SDP3           , {GpioPadModeGpio     , GpioHostOwnGpio, GpioDirInOut , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
// SPARE (GPIO_22)
{ NORTH_ALL_GBE2_LED0           , {GpioPadModeGpio     , GpioHostOwnGpio, GpioDirOut   , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
// SPARE (GPIO_23)
{ NORTH_ALL_GBE2_LED1           , {GpioPadModeGpio     , GpioHostOwnGpio, GpioDirOut   , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
...
// SPARE (GPIO_34)
{ NORTH_ALL_NCSI_TXD0           , {GpioPadModeGpio     , GpioHostOwnGpio, GpioDirOut   , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
// NV_CLEAR (GPIO_35)
...
// GBE_MDIO /BIOS SWAP GPIO (GPIO_2)
...
// SMI (GPIO_98)
{ SOUTH_GROUP0_PCIE_CLKREQ5_N   , {GpioPadModeGpio     , GpioHostOwnGpio, GpioDirIn    , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
// NMI (GPIO_99)
{ SOUTH_GROUP0_PCIE_CLKREQ6_N   , {GpioPadModeGpio     , GpioHostOwnGpio, GpioDirIn    , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
// FPRR_PROCHOT (GPIO_100)
{ SOUTH_GROUP0_PCIE_CLKREQ7_N   , {GpioPadModeGpio     , GpioHostOwnGpio, GpioDirIn    , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
// UART0_RXD (GPIO_101)
...
// SPARE (Pin strap) (GPIO_121)
{ SOUTH_GROUP0_FLEX_CLK_SE0     , {GpioPadModeGpio     , GpioHostOwnGpio, GpioDirOut   , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
// SPARE (Pin strap) (GPIO_122)
{ SOUTH_GROUP0_FLEX_CLK_SE1     , {GpioPadModeGpio     , GpioHostOwnGpio, GpioDirOut   , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
// SPARE (GPIO_4)
...
// PROCHOT_DISABLE (GPIO_90)
{ SOUTH_GROUP0_SATA0_LED_N      , {GpioPadModeGpio     , GpioHostOwnGpio, GpioDirNone  , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
// SPARE (GPIO_91)
{ SOUTH_GROUP0_SATA1_LED_N      , {GpioPadModeGpio     , GpioHostOwnGpio, GpioDirNone  , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
// SPARE (GPIO_92)
...
// SPARE (GPIO_95)
{ SOUTH_GROUP0_SATA1_SDOUT      , {GpioPadModeGpio     , GpioHostOwnGpio, GpioDirIn    , GpioOutDefault , GpioIntDefault, GpioResetDeep, GpioTermDefault, GpioLockDefault}} ,
// UART1_RXD (GPIO_96)
