...
// Reference: #define IS_MFG_MODE_LIST 
#define BOARD_SLOT_INFO { 1, "Slot1", SlotTypePciExpressGen3X8, SlotDataBusWidth8X, SlotLengthLong, SLOT_BUS_NO, 0x48}, { 2, "Slot2", SlotTypePciExpressGen3X4, SlotDataBusWidth4X, SlotLengthLong, SLOT_BUS_NO, 0x70}, { 3, "Slot3", SlotTypePciExpressGen3X4, SlotDataBusWidth4X, SlotLengthLong, SLOT_BUS_NO, 0x80},
