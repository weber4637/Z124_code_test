...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE0ECBEC9, 0xB193, 0x4351, {0xA4, 0x88, 0x36, 0xA6, 0x55, 0xF2, 0x2F, 0x9F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SaveMemoryConfigDxe";
...
{
  return SaveMemoryConfigEntryPoint (ImageHandle, SystemTable);
}
