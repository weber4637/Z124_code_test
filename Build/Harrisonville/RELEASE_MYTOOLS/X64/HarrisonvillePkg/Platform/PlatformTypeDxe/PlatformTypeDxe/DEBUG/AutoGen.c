...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x92946246, 0x843D, 0x42c8, {0x85, 0x72, 0x6C, 0x6B, 0x43, 0xD0, 0x26, 0xA2}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PlatformTypeDxe";
...
{
  return PlatformTypeInit (ImageHandle, SystemTable);
}
