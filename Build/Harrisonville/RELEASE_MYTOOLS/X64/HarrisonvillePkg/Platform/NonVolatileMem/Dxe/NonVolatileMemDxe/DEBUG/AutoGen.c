...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x3611a41a, 0x7930, 0x4d73, {0x9f, 0x14, 0xea, 0x40, 0x5e, 0x0e, 0x81, 0x37}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NonVolatileMemDxe";
...
{
  return NonVolatileMemDxeEntryPoint (ImageHandle, SystemTable);
}
