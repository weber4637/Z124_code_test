...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC47BFBC5, 0xC764, 0x4e78, {0x89, 0x53, 0xD7, 0x6B, 0x7B, 0xCD, 0x09, 0xC6}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CopyToFlashSmi";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (CopyToFlashEntry (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
