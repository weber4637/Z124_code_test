...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0D32E7AB, 0xFC86, 0x4b85, {0x9F, 0x37, 0x4E, 0x8D, 0x9D, 0x78, 0x81, 0x19}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PowerButtonSmm";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (PowerButtonEntry (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
