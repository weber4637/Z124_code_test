...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xe143c542, 0x4fc4, 0x4dd9, {0x99, 0xf2, 0x75, 0x71, 0x5c, 0x44, 0xe4, 0x1c}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "IePolicyInitDxe";
...
{
  return IePolicyInitDxeEntryPoint (ImageHandle, SystemTable);
}
