...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x24A44CAF, 0x0BF2, 0x4514, {0x90, 0xC4, 0xC7, 0x94, 0xB3, 0xE7, 0x78, 0xF5}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MeDxePolicyInit";
...
{
  return MeDxePolicyInitEntryPoint (ImageHandle, SystemTable);
}
