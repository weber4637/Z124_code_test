...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x76A7B4FC, 0xC8D5, 0x462d, {0xA4, 0xD2, 0x6E, 0x88, 0x33, 0x8A, 0x77, 0x2A}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PlatformCpuPolicy";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiPlatformCpuProtocolGuid = { 0xbd26cdc9, 0xa092, 0x462a, { 0x87, 0x7a, 0x5a, 0xb6, 0xad, 0xce, 0x48, 0x12 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gIntelCpuPcdsSetDoneProtocolGuid = { 0xadb7b9e6, 0x70b7, 0x48d4, { 0xb6, 0xa5, 0x18, 0xfa, 0x15, 0xeb, 0xcd, 0x78 }};
...
{
  return PlatformCpuPolicyEntryPoint (ImageHandle, SystemTable);
}
