...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2EE72E7C, 0xFB9E, 0x4318, {0xB8, 0x88, 0x33, 0xA3, 0x15, 0xC7, 0xA9, 0x1D}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PpmPolicy";
...
{
  return PpmPolicyEntry (ImageHandle, SystemTable);
}
