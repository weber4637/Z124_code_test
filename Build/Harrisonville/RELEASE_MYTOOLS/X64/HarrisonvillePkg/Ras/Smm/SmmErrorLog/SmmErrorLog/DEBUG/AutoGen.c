...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x36026EFE, 0xE214, 0x4ede, {0xA5, 0xD3, 0x85, 0x05, 0x38, 0x90, 0xD4, 0xA1}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmmErrorLog";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSmmBaseProtocolGuid = { 0x1390954D, 0xda95, 0x4227, { 0x93, 0x28, 0x72, 0x82, 0xc2, 0x17, 0xda, 0xa8 }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSmmGpiDispatchProtocolGuid = { 0xe0744b81, 0x9513, 0x49cd, { 0x8c, 0xea, 0xe9, 0x24, 0x5e, 0x70, 0x39, 0xda }};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitializeSmmErrorLog (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
