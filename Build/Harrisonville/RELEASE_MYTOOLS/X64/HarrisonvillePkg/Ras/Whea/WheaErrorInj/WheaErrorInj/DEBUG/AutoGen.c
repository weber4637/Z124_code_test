...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xFB6D36A2, 0xEF7D, 0x4B74, {0x99, 0xAC, 0x80, 0xB3, 0x1F, 0x6B, 0xE9, 0xB1}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "WheaErrorInj";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitWheaErrorInj (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
