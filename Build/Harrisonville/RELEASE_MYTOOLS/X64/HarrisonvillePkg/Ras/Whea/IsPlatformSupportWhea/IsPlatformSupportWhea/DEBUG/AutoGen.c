...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xB2CD74DE, 0x11F9, 0x418c, {0xBF, 0x2E, 0xDA, 0xC3, 0x03, 0x5A, 0xAB, 0x7A}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "IsPlatformSupportWhea";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiIsPlatformSupportWheaProtocolGuid = { 0x71c4c155, 0xd54b, 0x4d59, { 0xa2, 0xc1, 0xf9, 0xa5, 0x72, 0x3c, 0x65, 0xa8 }};
...
{
  return InstallIsPlatformSupportWhea (ImageHandle, SystemTable);
}
