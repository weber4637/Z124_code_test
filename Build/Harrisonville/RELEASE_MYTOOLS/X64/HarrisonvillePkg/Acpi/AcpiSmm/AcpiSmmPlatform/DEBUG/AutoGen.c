...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xF5AC7057, 0x5650, 0x466e, {0xB6, 0x92, 0x76, 0xA4, 0x72, 0x23, 0xEF, 0xB0}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AcpiSmmPlatform";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitAcpiSmmPlatform (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
