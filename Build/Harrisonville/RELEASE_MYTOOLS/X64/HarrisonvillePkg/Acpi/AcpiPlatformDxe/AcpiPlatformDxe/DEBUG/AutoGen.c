...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x368B3649, 0xF204, 0x4cd0, {0x89, 0xA8, 0x09, 0x10, 0x77, 0xC0, 0x70, 0xFA}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiBdatMemoryData2Guid = { 0xCE3F6794, 0x4883, 0x492C, {0x8D, 0xBA, 0x2F, 0xC0, 0x98, 0x44, 0x77, 0x10}};
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiGlobalNvsAreaProtocolGuid = {0x74e1e48, 0x8132, 0x47a1, { 0x8c, 0x2c, 0x3f, 0x14, 0xad, 0x9a, 0x66, 0xdc }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiLpcPolicyProtocolGuid = { 0x64021DFE, 0xA62C, 0x42A7, { 0xBF, 0x46, 0x15, 0x07, 0x8C, 0xDF, 0x9F, 0x89 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdHpetEnable = _PCD_VALUE_PcdHpetEnable;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdGeoSpiChipAddress = _PCD_VALUE_PcdGeoSpiChipAddress;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT64 _gPcd_FixedAtBuild_PcdGeoSpiChipSize = _PCD_VALUE_PcdGeoSpiChipSize;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdGeoSpiChipMagic = _PCD_VALUE_PcdGeoSpiChipMagic;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdIoApicBaseAddress = _PCD_VALUE_PcdIoApicBaseAddress;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdLocalApicAddress = _PCD_VALUE_PcdLocalApicAddress;
