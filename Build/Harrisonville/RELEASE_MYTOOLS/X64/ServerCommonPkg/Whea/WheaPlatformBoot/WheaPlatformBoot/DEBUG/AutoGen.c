...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xEA1D58A2, 0xEA3D, 0x4C14, {0x92, 0x8A, 0x80, 0xA1, 0x45, 0x45, 0xE6, 0x81}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "WheaPlatformBoot";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiWheaBootProtocolGuid = { 0x4a0266fe, 0xfe57, 0x4738, { 0x80, 0xab, 0x14, 0x6e, 0x46, 0xf0, 0x3a, 0x65 }};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (WheaPlatformBootEntry (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
