...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x492CB3AE, 0x66DB, 0x4f1e, {0x91, 0xAE, 0x53, 0x4C, 0x48, 0xF2, 0xF8, 0x3D}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "WheaSupport";
...
{
  return InstallWheaSupport (ImageHandle, SystemTable);
}
