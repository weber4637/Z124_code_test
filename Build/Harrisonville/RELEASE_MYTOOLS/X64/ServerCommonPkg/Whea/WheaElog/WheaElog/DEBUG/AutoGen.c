...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x20B181E2, 0x33E8, 0x4211, {0xB9, 0xD7, 0x9B, 0x86, 0x96, 0x76, 0x4E, 0x66}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "WheaElog";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiWheaElogFvGuid = { 0xd6a1cd70, 0x4b33, 0x4994, { 0xa6, 0xea, 0x37, 0x5f, 0x2c, 0xcc, 0x54, 0x37 }};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (WheaErstInit (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
