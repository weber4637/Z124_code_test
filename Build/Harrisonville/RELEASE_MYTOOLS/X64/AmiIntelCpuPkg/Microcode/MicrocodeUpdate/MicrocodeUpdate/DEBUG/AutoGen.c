...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xF3331DE6, 0x4A55, 0x44e4, {0xB7, 0x67, 0x74, 0x53, 0xF7, 0xA1, 0xA0, 0x21}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MicrocodeUpdate";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitializeMicrocodeSmm (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
