...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2AD511C7, 0x1B60, 0x4002, {0x84, 0x1D, 0x29, 0x98, 0xDD, 0xC1, 0x38, 0xEE}};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InSmmFunction (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
