...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x77EB6C06, 0xFD48, 0x488B, {0xA1, 0xB3, 0xAE, 0x0A, 0x70, 0x80, 0x13, 0x69}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiHashAlgorithmSha1NoPadGuid = { 0x24c5dc2f, 0x53e2, 0x40ca, { 0x9e, 0xd6, 0xa5, 0xd9, 0xa4, 0x9f, 0x46, 0x3b }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiHashAlgorithmSha256NoPadGuid = { 0x8628752a, 0x6cb7, 0x4814, { 0x96, 0xfc, 0x24, 0xa8, 0x15, 0xac, 0x22, 0x26 }};
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiDigitalSignatureProtocolGuid = { 0x5f87ba17, 0x957d, 0x433d, {0x9e, 0x15, 0xc0, 0xe7, 0xc8, 0x79, 0x88, 0x99 }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiSmmDigitalSignatureProtocolGuid = { 0x91ABC830, 0x16FC, 0x4D9E, {0xA1, 0x89, 0x5F, 0xC8, 0xBB, 0x41, 0x14, 0x02 }};
  ...
  )
{
  ...
  Status = RuntimeAmiCryptLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
  ...
  )
{
  ...
  Status = RuntimeAmiCryptLibDestructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
...
{
  return NotInSmmFunction (ImageHandle, SystemTable);
}
