...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x16271FCA, 0x55D9, 0x4a33, {0x93, 0xFC, 0x5A, 0x3E, 0xB1, 0x28, 0xDE, 0xB6}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CrbDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiEfiCrbInfoProtocolGuid = { 0xe516acef, 0xfa3c, 0x4068, { 0x8c, 0xe4, 0x88, 0x8d, 0x62, 0xb0, 0xe4, 0x97 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiBootScriptSaveGuid = { 0x470e1529, 0xb79e, 0x4e32, { 0xa0, 0xfe, 0x6a, 0x15, 0x6d, 0x29, 0xf9, 0xb2 }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gSdioBusInitProtocolGuid = {0x94c69847, 0xa0cf, 0x4635, { 0xaa, 0x23, 0xd2, 0x66, 0x7b, 0xd7, 0xf7, 0x91 } };
...
{
  return CrbDxeInit (ImageHandle, SystemTable);
}
