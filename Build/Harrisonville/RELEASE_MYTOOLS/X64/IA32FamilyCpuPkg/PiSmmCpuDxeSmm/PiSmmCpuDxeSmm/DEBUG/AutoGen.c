...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdCpuSmmMsrSaveStateEnable = _PCD_VALUE_PcdCpuSmmMsrSaveStateEnable;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdCpuSmmSmrr2Base = _PCD_VALUE_PcdCpuSmmSmrr2Base;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdCpuSmmSmrr2Size = _PCD_VALUE_PcdCpuSmmSmrr2Size;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdCpuSmmSmrr2CacheType = _PCD_VALUE_PcdCpuSmmSmrr2CacheType;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdCpuSmmUseDelayIndication = _PCD_VALUE_PcdCpuSmmUseDelayIndication;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdCpuSmmUseBlockIndication = _PCD_VALUE_PcdCpuSmmUseBlockIndication;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdCpuSmmUseSmmEnableIndication = _PCD_VALUE_PcdCpuSmmUseSmmEnableIndication;
