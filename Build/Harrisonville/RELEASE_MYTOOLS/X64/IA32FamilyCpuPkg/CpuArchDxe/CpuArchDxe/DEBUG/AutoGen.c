...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x62D171CB, 0x78CD, 0x4480, {0x86, 0x78, 0xC6, 0xA2, 0xA7, 0x97, 0xA8, 0xDE}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CpuArchDxe";
