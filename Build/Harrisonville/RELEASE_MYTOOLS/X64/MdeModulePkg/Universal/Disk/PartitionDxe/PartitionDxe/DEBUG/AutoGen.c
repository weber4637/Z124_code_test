...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiIso9660MediaGuid = { 0xba7c46d1, 0x9c5e, 0x4fc8, { 0x94, 0x3d, 0x1a, 0x49, 0x1f, 0x23, 0xfe, 0x01 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiUdfMediaGuid = { 0x7465ba75, 0x88a7, 0x4b61, { 0x9a, 0x7e, 0x6d, 0x4e, 0xdf, 0x68, 0x04, 0xdc } };
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdIso9660Support = _PCD_VALUE_PcdIso9660Support;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdUdfSupport = _PCD_VALUE_PcdUdfSupport;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_AmiPcdNumberOfRetriesOnNoMedia = _PCD_VALUE_AmiPcdNumberOfRetriesOnNoMedia;
