...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x291E46D4, 0xCA63, 0x4d33, {0x98, 0x57, 0x13, 0x97, 0xC9, 0xAD, 0x7C, 0x0D}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "LegacySmmSredir";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (LegacySredirSmmEntryPoint (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
