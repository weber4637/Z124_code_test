...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x196CA3D8, 0x9A5A, 0x4735, {0xB3, 0x28, 0x8F, 0xFC, 0x1D, 0x93, 0xD1, 0x88}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TcgPlatformSetupPolicy";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gTcgPpiSyncFlagGuid = {0xf3ed95df, 0x828e, 0x41c7, {0xbc, 0xa0, 0x16, 0xc4, 0x19, 0x65, 0xa6, 0x34} };
...
{
  return TcgPlatformSetupPolicyEntryPoint (ImageHandle, SystemTable);
}
