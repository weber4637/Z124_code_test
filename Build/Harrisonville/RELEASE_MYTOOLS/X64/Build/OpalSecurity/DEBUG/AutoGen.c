...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x59AF16B0, 0x661D, 0x4865, {0xA3, 0x81, 0x38, 0xDE, 0x68, 0x38, 0x5D, 0x8D}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "OpalSecurity";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiHddOpalSecInitProtocolGuid = { 0x59af16b0, 0x661d, 0x4865, { 0xa3, 0x81, 0x38, 0xde, 0x68, 0x38, 0x5d, 0x8d } };
...
{
  return OpalSecEntryPoint (ImageHandle, SystemTable);
}
