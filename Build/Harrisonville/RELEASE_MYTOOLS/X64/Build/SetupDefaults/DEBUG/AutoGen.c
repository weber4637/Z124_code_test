...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC8300EA9, 0x869E, 0x42df, {0xAE, 0xF2, 0x5D, 0x93, 0x94, 0x52, 0xA3, 0x53}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SetupDefaults";
...
{
  return SetupDefaultsEntry (ImageHandle, SystemTable);
}
