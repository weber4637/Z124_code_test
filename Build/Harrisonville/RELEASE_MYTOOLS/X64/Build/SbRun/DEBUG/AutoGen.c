...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE23F86E1, 0x056E, 0x4888, {0xB6, 0x85, 0xCF, 0xCD, 0x67, 0xC1, 0x79, 0xD4}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SbRun";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiTimeVariableGuid = {0x9d0da369, 0x540b, 0x46f8,{0x85, 0xa0, 0x2b, 0x5f, 0x2c, 0x30, 0x1e, 0x15}};
  ...
  )
{
  ...
  Status = SbRuntimeServiceLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
...
{
  return SbRuntimeInitEntryPoint (ImageHandle, SystemTable);
}
