...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x580DD900, 0x385D, 0x11d7, {0x88, 0x3A, 0x00, 0x50, 0x04, 0x73, 0xD4, 0xEB}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Uhcd";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gUsbTimingPolicyProtocolGuid = { 0x89e3c1dc, 0xb5e3, 0x4d34, { 0xae, 0xad, 0xdd, 0x7e, 0xb2, 0x82, 0x8c, 0x18 }};
...
{
  return AmiUsbDriverEntryPoint (ImageHandle, SystemTable);
}
