...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x21891A9E, 0x763E, 0x4377, {0x88, 0x41, 0x8D, 0x5C, 0x90, 0xD8, 0x8C, 0x51}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NetworkStackSetupScreen";
...
{
  return InitNetworkStackVar (ImageHandle, SystemTable);
}
