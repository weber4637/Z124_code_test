...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x171F43DC, 0xC4D9, 0x47a6, {0x96, 0x41, 0x65, 0xDD, 0xCD, 0xD5, 0xAA, 0x30}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "UsbRtDxe";
...
{
  return USBDriverEntryPoint (ImageHandle, SystemTable);
}
