...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0718AD81, 0xF26A, 0x4850, {0xA6, 0xEC, 0xF2, 0x68, 0xE3, 0x09, 0xD7, 0x07}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Tpm20PlatformDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiTpm20MeasureConfigurationInfoGuid = { 0x47144f62, 0xb423, 0x4524, 0xac, 0x6a, 0x90, 0x10, 0x6b, 0xaa, 0x89, 0xfb };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMicrocodeGuid = { 0x17088572, 0x377F, 0x44ef, 0x8F, 0x4E, 0xB0, 0x9F, 0xFF, 0x46, 0xA0, 0x70};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gTcgNvramHobGuid = { 0xc0ec00fd, 0xc2f8, 0x4e47, { 0x90, 0xef, 0x9c, 0x81, 0x55, 0x28, 0x5b, 0xec } };
...
{
  return Tpm20PlatformEntry (ImageHandle, SystemTable);
}
