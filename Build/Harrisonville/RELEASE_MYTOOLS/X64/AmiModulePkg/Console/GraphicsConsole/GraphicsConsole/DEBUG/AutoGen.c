...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x43e7abdd, 0xe352, 0x4cfb, {0xa2, 0x30, 0x4c, 0xdc, 0x1d, 0x35, 0x0e, 0x5c}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "GraphicsConsole";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiTextOutProtocolGuid = { 0xe1e4a857, 0xc970, 0x4075, { 0xa4, 0xda, 0xe9, 0xc4, 0x1b, 0x69, 0xad, 0xfc } };
...
{
  return GCEntryPoint (ImageHandle, SystemTable);
}
