...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x628a497d, 0x2bf6, 0x4264, {0x87, 0x41, 0x06, 0x9d, 0xbd, 0x33, 0x99, 0xd6}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ConSplitter";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiMultiLangSupportProtocolGuid = { 0xb295bd1c, 0x63e3, 0x48e3, { 0xb2, 0x65, 0xf7, 0xdf, 0xa2, 0x7, 0x1, 0x23 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdDefaultCursorState = _PCD_VALUE_PcdDefaultCursorState;
...
{
  return CSEntryPoint (ImageHandle, SystemTable);
}
