...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x755877A6, 0x4F10, 0x4A5C, {0x9B, 0x2E, 0x85, 0x21, 0x23, 0xB9, 0x68, 0x2C}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FlashSmiDxe";
...
{
  return FlashSmiDxeEntry (ImageHandle, SystemTable);
}
