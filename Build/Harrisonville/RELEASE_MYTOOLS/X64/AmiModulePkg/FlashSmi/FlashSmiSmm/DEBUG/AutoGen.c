...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6C289241, 0xE240, 0x483F, {0x9E, 0x3E, 0x87, 0x2C, 0x03, 0x96, 0xB5, 0x99}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FlashSmiSmm";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (FlashSmiSmmEntry (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
