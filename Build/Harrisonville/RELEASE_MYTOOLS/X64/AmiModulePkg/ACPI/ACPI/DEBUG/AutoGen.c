...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x16D0A23E, 0xC09C, 0x407d, {0xA1, 0x4A, 0xAD, 0x05, 0x8F, 0xDD, 0x0C, 0xA1}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ACPI";
  ...
  )
{
  ...
  Status = AmiAcpiLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
...
{
  return AcpiNewCoreEntry (ImageHandle, SystemTable);
}
