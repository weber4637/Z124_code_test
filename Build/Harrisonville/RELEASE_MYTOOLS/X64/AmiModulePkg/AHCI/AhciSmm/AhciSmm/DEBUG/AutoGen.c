...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBC3245BD, 0xB982, 0x4f55, {0x9F, 0x79, 0x05, 0x6A, 0xD7, 0xE9, 0x87, 0xC5}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AhciSmm";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiAhciSmmProtocolGuid = {0xB2FA5764, 0x3B6E, 0x43D3, { 0x91, 0xDF, 0x87, 0xD1, 0x5A, 0x3E, 0x56, 0x68 } };
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (AhciSmmDriverEntryPoint (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
