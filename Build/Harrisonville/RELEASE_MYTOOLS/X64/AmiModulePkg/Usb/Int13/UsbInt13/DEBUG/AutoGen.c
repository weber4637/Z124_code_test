...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x4C006CD9, 0x19BA, 0x4617, {0x84, 0x83, 0x60, 0x91, 0x94, 0xA1, 0xAC, 0xFC}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "UsbInt13";
...
{
  return UsbInt13EntryPoint (ImageHandle, SystemTable);
}
