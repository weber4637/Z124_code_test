...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x56BF094C, 0x69F6, 0x49dd, {0x8C, 0x1C, 0x1E, 0xCE, 0xFF, 0x71, 0xC9, 0xE5}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CsmRt32";
...
{
  return RT32_EntryPoint (ImageHandle, SystemTable);
}
