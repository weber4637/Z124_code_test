...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x25ACF158, 0xDD61, 0x4e64, {0x9A, 0x49, 0x55, 0x85, 0x1E, 0x9A, 0x26, 0xC7}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CsmBlockIo";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiCsmThunkDriverGuid = { 0x2362ea9c, 0x84e5, 0x4dff, { 0x83, 0xbc, 0xb5, 0xac, 0xec, 0xb5, 0x7c, 0xbb } };
...
{
  return CsmBlockIoEntryPoint (ImageHandle, SystemTable);
}
