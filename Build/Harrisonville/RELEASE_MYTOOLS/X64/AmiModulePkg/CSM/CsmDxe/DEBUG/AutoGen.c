...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xA062CF1F, 0x8473, 0x4aa3, {0x87, 0x93, 0x60, 0x0B, 0xC4, 0xFF, 0xE9, 0xA8}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CsmDxe";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gWinCeGuid = { 0xC184562C, 0x6864, 0x40a3, { 0xA0, 0x81, 0xC8, 0xD3, 0x5E, 0x82, 0xB9, 0x20 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiLegacyBiosPlatformProtocolGuid = { 0x783658a3, 0x4172, 0x4421, { 0xa2, 0x99, 0xe0, 0x09, 0x07, 0x9c, 0x0c, 0xb4 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAint13ProtocolGuid = { 0x67820532, 0x7613, 0x4dd3, { 0x9e, 0xd7, 0x3d, 0x9b, 0xe3, 0xa7, 0xda, 0x63 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiOemCsm16BinaryGuid = { 0xE998C6D8, 0x572B, 0x4e18, { 0x96, 0xCC, 0x03, 0x1E, 0xA3, 0xDD, 0x55, 0x8C } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiPciIrqProgramGuid = { 0x9400d59b, 0x0e9c, 0x4f6c, { 0xb5, 0x9a, 0xfc, 0x20, 0x00, 0x9d, 0xb9, 0xec } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiCsmStartedProtocolGuid = { 0x3EA824D1, 0x81E3, 0x4FF5, { 0xBD, 0x43, 0xBB, 0x9C, 0x65, 0xDF, 0x7C, 0x46 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiCsmVideoPolicyProtocolGuid = { 0x3a4e4376, 0x4871, 0x4b0e, { 0xa0, 0x2f, 0xed, 0x36, 0xf2, 0xae, 0xcd, 0x0 } };
...
{
  return CsmEntryPoint (ImageHandle, SystemTable);
}
