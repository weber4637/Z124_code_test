...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2688B232, 0x9C02, 0x4c12, {0xBE, 0x1F, 0x85, 0x7C, 0x0F, 0xF2, 0xAA, 0xE3}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TcgDxeplatform";
...
{
  return TcgDxeplatformEntry (ImageHandle, SystemTable);
}
