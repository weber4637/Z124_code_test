...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x858EBE6F, 0x360F, 0x415b, {0xB7, 0xDC, 0x46, 0x3A, 0xAE, 0xB0, 0x34, 0x12}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TcgLegacy";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gTcgLegX16FileGuid = {0x142204e2, 0xc7b1, 0x4af9, {0xa7, 0x29, 0x92, 0x37, 0x58, 0xd9, 0x6d, 0x3} };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gTpm32FileGuid = { 0xaa31bc6, 0x3379, 0x41e8, {0x82, 0x5a, 0x53, 0xf8, 0x2c, 0xc0, 0xf2, 0x54} };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMpTpmFileGuid = { 0x7d113aa9, 0x6280, 0x48c6, { 0xba, 0xce, 0xdf, 0xe7, 0x66, 0x8e, 0x83, 0x7} };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gTcmLegX16FileGuid = { 0x1E753E16, 0xDCEF, 0x47d0, { 0x9A, 0x38, 0x7A, 0xDE, 0xCD, 0xB9, 0x83, 0xED} };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gTcm32FileGuid = { 0xB74E676E,0x3B2E, 0x483f, { 0x94, 0x58, 0xC3, 0x78, 0xFE, 0x0A, 0xC6, 0x9F} };
...
{
  return InitTCGLegacyInterface (ImageHandle, SystemTable);
}
