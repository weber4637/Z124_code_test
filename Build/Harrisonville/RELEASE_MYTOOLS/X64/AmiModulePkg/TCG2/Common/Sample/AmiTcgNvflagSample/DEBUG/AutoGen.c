...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x50F6096D, 0x7C98, 0x4c78, {0x9A, 0x1D, 0xC5, 0xA1, 0x83, 0x3B, 0x6A, 0x88}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AmiTcgNvflagSample";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID FlagsStatusguid = {0x7d3dceee, 0xcbce, 0x4ea7, { 0x87, 0x09, 0x6e, 0x55, 0x2f, 0x1e, 0xdb, 0xde} };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID mAmiPpiInternalVarGuid = { 0x78097bb6, 0x48cf, 0x449b, { 0x9b, 0xdb, 0xf6, 0x38, 0x49, 0x85, 0x64, 0x60} };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID mAmiTcgInterfaceVarGuid = { 0x6e6ebc2d, 0x77ab, 0x46cf, {0xb2, 0xa7, 0xcc, 0x96, 0x8b, 0xe, 0x8a, 0xf3} };
...
{
  return AmiTcgPpiNvflagEntry (ImageHandle, SystemTable);
}
