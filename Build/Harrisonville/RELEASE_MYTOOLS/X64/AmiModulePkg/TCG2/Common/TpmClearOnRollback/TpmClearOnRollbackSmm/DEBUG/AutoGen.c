...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC56EDB22, 0x3D78, 0x4705, {0xA2, 0x22, 0xBD, 0xD6, 0xBD, 0x15, 0x4D, 0xA0}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TpmClearOnRollbackSmm";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiTpmRollbackSmmProtocolGuid = { 0x79fbad19, 0xf9e1, 0x4d08, 0xb7, 0xbc, 0x35, 0x84, 0x53, 0x19, 0x5e, 0x41};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (TpmClearRollBackSmmInit (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
