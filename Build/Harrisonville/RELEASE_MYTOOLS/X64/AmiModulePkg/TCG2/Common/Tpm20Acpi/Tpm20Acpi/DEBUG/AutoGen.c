...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x4C8BDF60, 0x2085, 0x4577, {0x8A, 0x46, 0x96, 0xCB, 0x18, 0x09, 0x67, 0xBC}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Tpm20Acpi";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPttSsdtAcpiTableGuid = { 0xb733c141, 0xe88f, 0x4786, {0x94, 0xaf, 0x8b, 0x87, 0xbc, 0x48, 0x67, 0xfe } };
...
{
  return Tpm20AcpiInitEntry (ImageHandle, SystemTable);
}
