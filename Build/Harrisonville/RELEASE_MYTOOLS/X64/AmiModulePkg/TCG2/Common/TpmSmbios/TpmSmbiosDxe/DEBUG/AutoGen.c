...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x077A3100, 0x1667, 0x45FA, {0xB9, 0x8C, 0x37, 0x65, 0x1B, 0x50, 0x73, 0xEE}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TpmSmbiosDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiTcg2InfoProtocolGuid = { 0x325a554,  0x5be,  0x466b, { 0xbc, 0x8c, 0x70, 0xbe, 0x3c, 0x9d, 0xaf, 0xb1 } };
...
{
  return TpmSmbiosDxeEntry (ImageHandle, SystemTable);
}
