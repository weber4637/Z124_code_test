...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xFD93F9E1, 0x3C73, 0x46e0, {0xB7, 0xB8, 0x2B, 0xBA, 0x3F, 0x71, 0x8F, 0x6C}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiNvramControlProtocolGuid = { 0xf7ca7568, 0x5a09, 0x4d2c, 0x8a, 0x9b, 0x75, 0x84, 0x68, 0x59, 0x2a, 0xe2 };
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (TCGSmmInit (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
