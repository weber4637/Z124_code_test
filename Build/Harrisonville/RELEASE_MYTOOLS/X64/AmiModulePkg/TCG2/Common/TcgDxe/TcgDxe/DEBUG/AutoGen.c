...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x5E9CABA3, 0xF2B1, 0x497a, {0xAD, 0xAC, 0x24, 0xF5, 0x75, 0xE9, 0xCD, 0xE9}};
...
{
  return CommonTcgDxEntryPoint (ImageHandle, SystemTable);
}
