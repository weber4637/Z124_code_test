...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1ED46147, 0x76E3, 0x4171, {0xBC, 0xE5, 0x42, 0xD3, 0x68, 0xD2, 0x6A, 0xA6}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DebugPortTableDxe";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiAcpiSupportProtocolGuid = { 0xdbff9d55, 0x89b7, 0x46da, { 0xbd, 0xdf, 0x67, 0x7d, 0x3d, 0xc0, 0x24, 0x1d }};
...
#define _PCD_VALUE_PcdFixedDebugPrintErrorLevel  0U
...
{
  return DebugPortTableDxeEntryPoint (ImageHandle, SystemTable);
}
