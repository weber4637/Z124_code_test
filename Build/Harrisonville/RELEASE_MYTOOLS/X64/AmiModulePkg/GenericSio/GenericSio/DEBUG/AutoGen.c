...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x8EEF9AD2, 0x463E, 0x425f, {0xA4, 0xFE, 0x2F, 0x67, 0x83, 0xD6, 0xF9, 0x7E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "GenericSio";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiSioPortCompatibilityProtocolGuid = { 0x4250cec2, 0xdddb, 0x400b, { 0x8c, 0x62, 0xcf, 0x98, 0x64, 0xf6, 0xd1, 0x54 }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiSioSmmHandoffProtocolGuid = { 0x7576cc89, 0x8fa3, 0x4cad, { 0xba, 0x02, 0x61, 0x19, 0xb4, 0x6e, 0xd4, 0x4a } };
...
{
  return GenericSioEntryPoint (ImageHandle, SystemTable);
}
