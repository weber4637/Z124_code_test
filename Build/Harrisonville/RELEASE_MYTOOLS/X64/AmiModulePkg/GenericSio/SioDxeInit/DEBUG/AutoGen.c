...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x4E82091E, 0x32A1, 0x4689, {0x8A, 0x00, 0xCD, 0xE4, 0x1E, 0xD6, 0x3C, 0xDD}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SioDxeInit";
...
{
  return SioDxeInitEntryPoint (ImageHandle, SystemTable);
}
