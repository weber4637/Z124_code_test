...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9F3A0016, 0xAE55, 0x4288, {0x82, 0x9D, 0xD5, 0x5F, 0xD3, 0xAA, 0xC3, 0x47}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AmiBoardInfo2";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiBoardInfoFileGuid = { 0x7b9a0a12, 0x42f8, 0x4d4c, { 0x82, 0xb6, 0x32, 0xf0, 0xca, 0x19, 0x53, 0xf4 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiBoardInfoSectionGuid = { 0x9bec7109, 0x6d7a, 0x413a, { 0x8e, 0x4b, 0x1,  0x9c, 0xed, 0x5,  0x3,  0xe1 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiAslDsdtFileGuid = { 0xc118f50d, 0x391d, 0x45f4, { 0xb3, 0xd3, 0x11, 0xbc, 0x93, 0x1a, 0xa5, 0x6d } };
...
{
  return AmiBoardEntryPoint (ImageHandle, SystemTable);
}
