...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x935D2F78, 0x3A1F, 0x4de6, {0xB2, 0x8D, 0x12, 0x3A, 0x40, 0xDD, 0x2D, 0xEC}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmmGenericElog";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiGenericElogProtocolGuid = { 0x59d02fcd, 0x9233, 0x4d34, { 0xbc, 0xfe, 0x87, 0xca, 0x81, 0xd3, 0xdd, 0xa7 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiGenericElogSmmProtocolInstallled = { 0xa4223cf1, 0x6b27, 0x4994, { 0x8f, 0xcb, 0xa3, 0xa2, 0x79, 0xc0, 0x4e, 0x81 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiRedirElogProtocolGuid = { 0x16d11030, 0x71ba, 0x4e5e, { 0xa9, 0xf9, 0xb4, 0x75, 0xa5, 0x49, 0x4, 0x8a } };
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitializeSmmGenericElog (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
