...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x3B0673A3, 0x5197, 0x454c, {0xBA, 0x76, 0xE2, 0xD0, 0xC8, 0xC4, 0x8E, 0xFD}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "GenericElog";
...
{
  return InitializeGenericElog (ImageHandle, SystemTable);
}
