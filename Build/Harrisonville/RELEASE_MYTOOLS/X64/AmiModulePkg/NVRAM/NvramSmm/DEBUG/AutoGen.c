...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x447A1B58, 0x8F3E, 0x4658, {0xAB, 0xAA, 0x9E, 0x7B, 0x22, 0x80, 0xB9, 0x0A}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NvramSmm";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiSmmFlashProtocolGuid = { 0xecb867ab, 0x8df4, 0x492d, { 0x81, 0x50, 0xa7, 0xfd, 0x1b, 0x9b, 0x5a, 0x75 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiSmmNvramUpdateProtocolGuid = { 0xf3224a5e, 0x17a3, 0x47c2, { 0xa3, 0x8b, 0x48, 0x14, 0x56, 0x86, 0x3c, 0x74 } };
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (NvramSmmInit (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
