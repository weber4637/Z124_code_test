...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1807040D, 0x5934, 0x41A2, {0xA0, 0x88, 0x8E, 0x0F, 0x77, 0x7F, 0x71, 0xAB}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NvramDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiNvramSmmCommunicationGuid = { 0x45ac8863, 0xe3fa, 0x4a38, { 0xa2, 0x3c, 0x0, 0xbc, 0xd1, 0xc, 0xbd, 0x50 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiFlashProtocolGuid = { 0x755b6596, 0x6896, 0x4ba3, { 0xb3, 0xdd, 0x1c, 0x62, 0x9f, 0xd1, 0xea, 0x88 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiLegacyBootProtocolGuid = { 0x120d28aa, 0x6630, 0x46f0, { 0x81, 0x57, 0xc0, 0xad, 0xc2, 0x38, 0x3b, 0xf5 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiNvramUpdateProtocolGuid = { 0xdde31574, 0x3589, 0x4fa9, { 0xbc, 0x69, 0x17, 0x29, 0xaf, 0x6f, 0xda, 0x4e } };
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_AmiPcdNvramSmmSupport = _PCD_VALUE_AmiPcdNvramSmmSupport;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdVariableStoreSize = _PCD_VALUE_PcdVariableStoreSize;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_AmiPcdNvramResetPropertyMask = _PCD_VALUE_AmiPcdNvramResetPropertyMask;
  ...
  )
{
  ...
  Status = DxeRuntimePciExpressLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
  ...
  )
{
  ...
  Status = DxeRuntimePciExpressLibDestructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
...
{
  return NvRamInit (ImageHandle, SystemTable);
}
