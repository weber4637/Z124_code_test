...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xAB7ED12E, 0x1D78, 0x4635, {0xAB, 0x87, 0x23, 0xF0, 0x0A, 0x91, 0x1E, 0xC7}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "RomLayoutDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID AmiRomLayoutProtocolGuid = { 0xaabe9a45, 0xb345, 0x49d2, { 0x88, 0xef, 0x6a, 0xd0, 0xb8, 0x5e, 0xd7, 0xe6 } };
...
{
  return RomLayoutDxeEntryPoint (ImageHandle, SystemTable);
}
