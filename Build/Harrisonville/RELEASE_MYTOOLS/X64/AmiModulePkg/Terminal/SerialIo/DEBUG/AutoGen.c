...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x97C81E5D, 0x8FA0, 0x486a, {0xAA, 0xEA, 0x0E, 0xFD, 0xF0, 0x90, 0xFE, 0x4F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SerialIo";
...
{
  return SerialIoEntryPoint (ImageHandle, SystemTable);
}
