...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC9A6DE36, 0xFDFF, 0x4FAF, {0x83, 0x43, 0x85, 0xD9, 0xE3, 0x47, 0x0F, 0x43}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NvmeInt13";
...
{
  return NvmeInt13EntryPoint (ImageHandle, SystemTable);
}
