...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x668706B2, 0xBCFC, 0x4ad4, {0xA1, 0x85, 0x75, 0xE7, 0x9F, 0x3F, 0xE1, 0x69}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NvmeDynamicSetup";
...
{
  return NvmeDynamicSetupEntryPoint (ImageHandle, SystemTable);
}
