...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x53D7E8EC, 0x56F5, 0x4F9C, {0x81, 0x98, 0x7B, 0xFB, 0x2E, 0xD4, 0xE0, 0x5E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "BootSectorWriteProtect";
...
{
  return BootSectorWriteProtectEntryPoint (ImageHandle, SystemTable);
}
