...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x81A4F912, 0xE72F, 0x44ed, {0x89, 0x31, 0x16, 0xA9, 0xFE, 0x96, 0x50, 0xE0}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "KbcEmulDxe";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gNonSmmEmul6064TrapProtocolGuid = { 0x68b81e51, 0x2583, 0x4582, { 0x95, 0xdb, 0xc5, 0x72, 0x32, 0x36, 0xc4, 0xf1 }};
...
{
  return EmulationDxeEntryPoint (ImageHandle, SystemTable);
}
