...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x3b24f79d, 0x91a0, 0x46ff, {0xbe, 0x29, 0x45, 0x8a, 0xe2, 0x11, 0xfa, 0xc5}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "KbcEmul";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (EmulationEntryPoint (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
