...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x4A3602BC, 0x1A05, 0x4c82, {0x99, 0xB4, 0x58, 0x8C, 0xD2, 0xA3, 0x2C, 0xD5}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "LegacySredir";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiLegacyBiosExtProtocolGuid = { 0x8e008510, 0x9bb1, 0x457d, { 0x9f, 0x70, 0x89, 0x7a, 0xba, 0x86, 0x5d, 0xb9 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiLegacySredirProtocolGuid = { 0xA062CF1F, 0x8473, 0x4aa3, { 0x87, 0x93, 0x60, 0x0B, 0xC4, 0xFF, 0xA9, 0xA9 } };
...
{
  return LegacySredirEntryPoint (ImageHandle, SystemTable);
}
