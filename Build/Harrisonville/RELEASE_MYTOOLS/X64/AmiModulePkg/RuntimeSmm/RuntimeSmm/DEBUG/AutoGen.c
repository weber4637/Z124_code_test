...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x4a6d890f, 0x93c3, 0x4b6d, {0xa6, 0x7d, 0x5f, 0x2c, 0x4d, 0xce, 0x34, 0x7b}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "RuntimeSmm";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (RuntimeEntry (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
