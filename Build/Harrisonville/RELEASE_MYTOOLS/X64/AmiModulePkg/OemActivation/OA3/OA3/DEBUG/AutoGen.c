...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x76D5CF91, 0x0C55, 0x434E, {0x97, 0xC2, 0xD2, 0x82, 0x5C, 0x82, 0xE6, 0x10}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "OA3";
...
{
  return OA3_EntryPoint (ImageHandle, SystemTable);
}
