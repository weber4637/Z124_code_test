...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x8434DA1F, 0x5CEB, 0x402e, {0xA9, 0x3C, 0x03, 0x8C, 0xBE, 0x0F, 0x3F, 0x0E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "OA3_SMM";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (OA3_SMM_EntryPoint (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
