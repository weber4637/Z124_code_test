...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x70e1a818, 0x0be1, 0x4449, {0xbf, 0xd4, 0x9e, 0xf6, 0x8c, 0x7f, 0x02, 0xa8}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ReFlash";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiNvramMainRomAreaGuid = { 0xfa4974fc, 0xaf1d, 0x4e5d, { 0xbd, 0xc5, 0xda, 0xcd, 0x6d, 0x27, 0xba, 0xec } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiNvramBackupRomAreaGuid = { 0xa7edebd8, 0xa8d7, 0x48f8, { 0x81, 0xfb, 0x83, 0x76, 0x56, 0xb8, 0x20, 0x77 } };
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gFlashProtocolGuid = { 0x755b6596, 0x6896, 0x4ba3, { 0xb3, 0xdd, 0x1c, 0x62, 0x9f, 0xd1, 0xea, 0x88 }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiReflashProtocolGuid = { 0x8fe545e5, 0xdca9, 0x4d52, { 0xbf, 0xcd, 0x8f, 0x13, 0xe7, 0x17, 0x01, 0x5f } };
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdRecoveryImageSize = _PCD_VALUE_PcdRecoveryImageSize;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_AmiPcdInstallEsrtTable = _PCD_VALUE_AmiPcdInstallEsrtTable;
  ...
  )
{
  ...
  Status = DxeAmiRomLayoutLibConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
...
{
  return ReFlashEntry (ImageHandle, SystemTable);
}
