...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xe90a7b5e, 0x37b2, 0x43e4, {0xb2, 0x81, 0x4c, 0x8e, 0x34, 0x90, 0x45, 0xe9}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ReFlashSmm";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (ReFlashSmmEntry (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
