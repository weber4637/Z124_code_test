...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBC327DBD, 0xB982, 0x4f55, {0x9F, 0x79, 0x05, 0x6A, 0xD7, 0xE9, 0x87, 0xC5}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmiFlash";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (SMIFlashDriverEntryPoint (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
