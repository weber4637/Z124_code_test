...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBB8C2CF3, 0xA5E3, 0x49EF, {0x94, 0x1B, 0x4A, 0x01, 0xFA, 0xC6, 0xFD, 0x5F}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmiFlashDxe";
...
{
  return SmiFlashDxeEntry (ImageHandle, SystemTable);
}
