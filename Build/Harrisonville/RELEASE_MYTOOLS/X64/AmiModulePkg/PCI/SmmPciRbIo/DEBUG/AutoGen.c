...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x37A01080, 0x2346, 0x4a54, {0x99, 0x00, 0xD2, 0x2B, 0x7B, 0x68, 0x7C, 0x22}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmmPciRbIo";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (SmmPciRootBridgeInit (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
