...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x502B04F3, 0x71AB, 0x47b4, {0xBE, 0xAE, 0x47, 0x36, 0xEA, 0x19, 0x0A, 0xA4}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PciDxeInit";
...
{
  return PciDxeInitEntryPoint (ImageHandle, SystemTable);
}
