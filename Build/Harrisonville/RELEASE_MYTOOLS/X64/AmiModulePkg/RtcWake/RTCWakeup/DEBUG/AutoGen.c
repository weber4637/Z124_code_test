...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9BFE0707, 0x8174, 0x4B8A, {0xA5, 0xF5, 0x55, 0x6F, 0xB1, 0x0E, 0x88, 0x43}};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitRTCWakeup (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
