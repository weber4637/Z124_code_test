...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x271B424E, 0xA4CC, 0x4e0e, {0x90, 0xA2, 0x7E, 0xA4, 0x84, 0x1F, 0x12, 0xF3}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "ExportHiiDb";
...
{
  return ExportHiiDbEntryPoint (ImageHandle, SystemTable);
}
