...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x53BCC14F, 0xC24F, 0x434C, {0xB2, 0x94, 0x8E, 0xD2, 0xD4, 0xCC, 0x18, 0x60}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DataHubDxe";
...
{
  return DataHubInstall (ImageHandle, SystemTable);
}
