...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x2BDED685, 0xF733, 0x455f, {0xA8, 0x40, 0x43, 0xA2, 0x2B, 0x79, 0x1F, 0xB3}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AcpiS3SaveDxe";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiAcpiVariableCompatiblityGuid = { 0xc020489e, 0x6db2, 0x4ef2, { 0x9a, 0xa5, 0xca, 0x6,  0xfc, 0x11, 0xd3, 0x6a }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gFrameworkEfiMpServiceProtocolGuid = { 0xf33261e7, 0x23cb, 0x11d5, {0xbd, 0x5c, 0x0, 0x80, 0xc7, 0x3c, 0x88, 0x81}};
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdPlatformCsmSupport = _PCD_VALUE_PcdPlatformCsmSupport;
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdS3AcpiReservedMemorySize = _PCD_VALUE_PcdS3AcpiReservedMemorySize;
...
{
  return InstallAcpiS3Save (ImageHandle, SystemTable);
}
