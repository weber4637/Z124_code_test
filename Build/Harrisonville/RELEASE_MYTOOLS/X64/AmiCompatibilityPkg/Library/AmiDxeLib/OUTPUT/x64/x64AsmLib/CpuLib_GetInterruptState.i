#line 1 "d:\\bios\\z124-002\\z124-002\\AmiCompatibilityPkg\\Library\\x64\\x64AsmLib\\CpuLib_GetInterruptState.asm"
...
;
; Output:
;  ((BOOLEAN)(0==1)) if interrupts are disabled; otherwise ((BOOLEAN)(1==1)).
;
; Modified:
;
; Referrals:
