...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xCEF68C66, 0x06AB, 0x4fb3, {0xA3, 0xED, 0x5F, 0xFA, 0x88, 0x5B, 0x57, 0x25}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmbiosBoard";
...
{
  return SMIBiosBoardDriverEntryPoint (ImageHandle, SystemTable);
}
