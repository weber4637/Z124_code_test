...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE2A74738, 0x8934, 0x48f5, {0x84, 0x12, 0x99, 0xE9, 0x48, 0xC8, 0xDC, 0x1B}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmbiosDmiEdit";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiSmbiosProtocolGuid = { 0x5e90a50d, 0x6955, 0x4a49, { 0x90, 0x32, 0xda, 0x38, 0x12, 0xf8, 0xe8, 0xe5 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiSmbiosFlashDataProtocolGuid = { 0xddfb5557, 0x3e2e, 0x4569, { 0xb4, 0x59, 0xbe, 0xff, 0xe1, 0x89, 0xb8, 0xb0 } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSmiFlashProtocolGuid = { 0x6f2c06a8, 0xd4b4, 0x4a93, { 0x9f, 0x78, 0x2b, 0x48, 0x0b, 0xe8, 0x0e, 0x0f } };
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gFlashSmmProtocolGuid = { 0xecb867ab, 0x8df4, 0x492d, { 0x81, 0x50, 0xa7, 0xfd, 0x1b, 0x9b, 0x5a, 0x75 }};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (SmbiosDmiEditSupportInstall (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
