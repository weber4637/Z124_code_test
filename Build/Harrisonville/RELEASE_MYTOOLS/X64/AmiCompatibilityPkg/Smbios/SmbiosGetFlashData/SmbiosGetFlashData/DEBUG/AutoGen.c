...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xDED7956D, 0x7E20, 0x4f20, {0x91, 0xA1, 0x19, 0x04, 0x39, 0xB0, 0x4D, 0x5B}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmbiosGetFlashData";
...
{
  return SmbiosGetFlashDataInstall (ImageHandle, SystemTable);
}
