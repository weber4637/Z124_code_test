...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xB13EDD38, 0x684C, 0x41ed, {0xA3, 0x05, 0xD7, 0xB7, 0xE3, 0x24, 0x97, 0xDF}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Smbios";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiSmbiosStaticDataGuid = { 0xdaf4bf89, 0xce71, 0x4917, { 0xb5, 0x22, 0xc8, 0x9d, 0x32, 0xfb, 0xc5, 0x9f } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiSmbrunGuid = { 0x2b8a4061, 0x9131, 0x4d2a, { 0xa2, 0x0b, 0xd8, 0x45, 0xd0, 0xeb, 0x1d, 0x83 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiSmbiosBoardProtocolGuid = { 0x903dd14, 0x2ca0, 0x458a, { 0xb5, 0xeb, 0xc, 0xc, 0xa3, 0xd, 0x78, 0x5c } };
