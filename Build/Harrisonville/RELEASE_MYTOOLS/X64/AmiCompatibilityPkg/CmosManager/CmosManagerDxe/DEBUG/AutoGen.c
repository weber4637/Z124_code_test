...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x3237418A, 0x478C, 0x4700, {0xB5, 0x9F, 0x76, 0x8E, 0x2C, 0xCB, 0xC7, 0x26}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CmosDxe";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiCmosAccessDxeProtocolGuid = { 0x9851740c, 0x22e0, 0x440d, { 0x90, 0x90, 0xef, 0x2d, 0x71, 0xc2, 0x51, 0xc9 } };
...
{
  return CmosManagerDxeEntry (ImageHandle, SystemTable);
}
