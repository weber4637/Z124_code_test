...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x55E76644, 0x78A5, 0x4a82, {0xA9, 0x00, 0x71, 0x26, 0xA5, 0x79, 0x88, 0x92}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HeciInitDxe";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gMePlatformReadyToBootGuid = { 0x3fdf171, 0x1d67, 0x4ace, { 0xa9, 0x4, 0x3e, 0x36, 0xd3, 0x38, 0xfa, 0x74 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiMeInfoProtocolGuid = { 0x11fbfdfb, 0x10d2, 0x43e6, { 0xb5, 0xb1, 0xb4, 0x38, 0x6e, 0xdc, 0xcb, 0x9a }};
...
{
  return HeciDxeEntryPoint (ImageHandle, SystemTable);
}
