...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x921CD783, 0x3E22, 0x4579, {0xA7, 0x1F, 0x00, 0xD7, 0x41, 0x97, 0xFC, 0xC8}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HeciSmm";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gSmmHeciProtocolGuid = { 0x7a305c6c, 0x61ae, 0x4bec, { 0xa7, 0xad, 0xec, 0xe3, 0xfb, 0x8f, 0xef, 0xd1 }};
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (HeciSmmEntryPoint (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
