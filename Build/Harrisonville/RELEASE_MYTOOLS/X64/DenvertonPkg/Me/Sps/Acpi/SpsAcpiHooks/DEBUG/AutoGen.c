...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x7adbad98, 0x7fe1, 0x4774, {0x92, 0x60, 0x74, 0x73, 0x27, 0x43, 0x5e, 0x6d}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SpsAcpiHooks";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSpsAcpiTableLocatorGuid = { 0x4896840D, 0x46BB, 0x412B, { 0xA3, 0x0A, 0xA6, 0x2A, 0xBF, 0xB3, 0x68, 0x2F }};
...
{
  return SpsUpdateAslForMe (ImageHandle, SystemTable);
}
