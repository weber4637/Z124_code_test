...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xACD28235, 0x075B, 0x48b5, {0x98, 0xA1, 0xDA, 0x04, 0xFC, 0xAF, 0x84, 0xF3}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SiInitDxe";
...
{
  return SiInitDxe (ImageHandle, SystemTable);
}
