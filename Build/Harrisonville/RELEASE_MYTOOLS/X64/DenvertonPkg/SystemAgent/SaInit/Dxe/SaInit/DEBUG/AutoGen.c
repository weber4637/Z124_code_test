...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xDE23ACEE, 0xCF55, 0x4fb6, {0xAA, 0x77, 0x98, 0x4A, 0xB5, 0x3D, 0xE8, 0x11}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SaInit";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gSaAcpiTableStorageGuid = { 0x27E569D5, 0xAFC, 0x4D8F, { 0x8C, 0x90, 0x78, 0x3A, 0xC4, 0xA3, 0x18, 0xAB } };
...
{
  return SaInitEntryPoint (ImageHandle, SystemTable);
}
