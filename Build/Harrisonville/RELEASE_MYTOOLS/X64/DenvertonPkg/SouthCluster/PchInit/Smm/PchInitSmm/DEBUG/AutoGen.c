...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xD7B10D4E, 0x67E6, 0x4C74, {0x83, 0xE9, 0xF9, 0xAF, 0x0A, 0xCC, 0x33, 0xCC}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PchInitSmm";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (PchInitSmmEntryPoint (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
