...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xDE23ACEE, 0xCF55, 0x4fb6, {0xAA, 0x77, 0x98, 0x4A, 0xB5, 0x3D, 0xE8, 0x23}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PchInitDxe";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchInfoProtocolGuid = {0x984eb4e9, 0x5a95, 0x41de, {0xaa, 0xd0, 0x53, 0x66, 0x8c, 0xa5, 0x13, 0xc0}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchNvsAreaProtocolGuid = {0x2E058B2B, 0xEDC1, 0x4431, {0x87, 0xD9, 0xC6, 0xC4, 0xEA, 0x10, 0x2B, 0xE3}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchPcieIoTrapProtocolGuid = { 0xd66a1cf, 0x79ad, 0x494b, { 0x97, 0x8b, 0xb2, 0x59, 0x81, 0x68, 0x93, 0x34 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdEfiGcdAllocateType = _PCD_VALUE_PcdEfiGcdAllocateType;
...
{
  return PchInitEntryPointUefi (ImageHandle, SystemTable);
}
