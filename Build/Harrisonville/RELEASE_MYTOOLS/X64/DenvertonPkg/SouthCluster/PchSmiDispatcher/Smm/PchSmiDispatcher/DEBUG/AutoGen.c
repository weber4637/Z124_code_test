...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xB0D6ED53, 0xB844, 0x43f5, {0xBD, 0x2F, 0x61, 0x09, 0x52, 0x64, 0xE7, 0x7E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PchSmiDispatcher";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchTcoSmiDispatchProtocolGuid = {0x9E71D609, 0x6D24, 0x47FD, {0xB5, 0x72, 0x61, 0x40, 0xF8, 0xD9, 0xC2, 0xA4}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchPcieSmiDispatchProtocolGuid = {0x3E7D2B56, 0x3F47, 0x42AA, {0x8F, 0x6B, 0x22, 0xF5, 0x19, 0x81, 0x8D, 0xAB}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchAcpiSmiDispatchProtocolGuid = {0xD52BB262, 0xF022, 0x49EC, {0x86, 0xD2, 0x7A, 0x29, 0x3A, 0x7A, 0x05, 0x4B}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchGpioUnlockSmiDispatchProtocolGuid = {0x83339EF7, 0x9392, 0x4716, {0x8D, 0x3A, 0xD1, 0xFC, 0x67, 0xCD, 0x55, 0xDB}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchSmiDispatchProtocolGuid = {0x4566C59F, 0x650B, 0x4B63, {0xB1, 0xEF, 0x4F, 0x36, 0x66, 0x54, 0x4B, 0xEF}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchEspiSmiDispatchProtocolGuid = {0xca236c1b, 0x625c, 0x4753, {0xb5, 0x53, 0x19, 0x05, 0xfc, 0xec, 0x2e, 0xa7}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchSmmPeriodicTimerControlGuid = {0x6906E93B, 0x603B, 0x4A0F, {0x86, 0x92, 0x83, 0x20, 0x04, 0xAA, 0xF2, 0xDB}};
  ...
  )
{
  ...
  Status = SmmS3BootScriptLibS3SmmSaveStateProtocolConstructor (ImageHandle, SystemTable);
  ASSERT_EFI_ERROR (Status);
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitializePchSmmDispatcher (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
