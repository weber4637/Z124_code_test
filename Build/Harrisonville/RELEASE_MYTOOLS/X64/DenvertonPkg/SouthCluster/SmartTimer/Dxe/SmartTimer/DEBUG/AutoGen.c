...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x90CB75DB, 0x71FC, 0x489d, {0xAA, 0xCF, 0x94, 0x34, 0x77, 0xEC, 0x72, 0x12}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmartTimer";
