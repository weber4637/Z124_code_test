...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x334D5254, 0x6160, 0x4e4a, {0xA7, 0x8C, 0xE1, 0x5D, 0x3B, 0x3B, 0x33, 0x34}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MmcHost";
...
{
  return SdHostDriverEntryPoint (ImageHandle, SystemTable);
}
