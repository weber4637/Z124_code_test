...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xA0BAD9F7, 0xAB78, 0x491b, {0xB5, 0x83, 0xC5, 0x2B, 0x7F, 0x84, 0xB9, 0xE0}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmmControl";
...
{
  return SmmControlDriverEntryInit (ImageHandle, SystemTable);
}
