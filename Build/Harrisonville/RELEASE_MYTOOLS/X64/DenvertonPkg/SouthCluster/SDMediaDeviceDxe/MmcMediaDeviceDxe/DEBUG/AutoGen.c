...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xDD223EF8, 0x6D1B, 0x490a, {0xA5, 0x3E, 0xBA, 0x86, 0xFA, 0xAE, 0xB7, 0x78}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MmcMediaDevice";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiSdHostIoProtocolGuid = {0xb63f8ec7, 0xa9c9, 0x4472, {0xa4, 0xc0, 0x4d, 0x8b, 0xf3, 0x65, 0xcc, 0x51}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiEmmcCardInfoProtocolGuid = {0x1ebe5ab9, 0x2129, 0x49e7, {0x84, 0xd7, 0xee, 0xb9, 0xfc, 0xe5, 0xde, 0xdd}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiEmmcBootPartitionProtocolGuid = {0xea7d60a6, 0x1050, 0x45e4, {0xbe, 0xdf, 0xbf, 0x17, 0x72, 0x90, 0xd4, 0xb2}};
...
{
  return MediaDeviceDriverEntryPoint (ImageHandle, SystemTable);
}
