...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBB1FBD4F, 0x2E30, 0x4793, {0x9B, 0xED, 0x74, 0xF6, 0x72, 0xBC, 0x8F, 0xFE}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PchResetRuntime";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchPowerCycleResetGuid = { 0x8d8ee25b, 0x66dd, 0x4ed8, { 0x8a, 0xbd, 0x14, 0x16, 0xe8, 0x8e, 0x1d, 0x24 }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchGlobalResetWithEcGuid = { 0xd22e6b72, 0x53cd, 0x4158, { 0x83, 0x3f, 0x6f, 0xd8, 0x7e, 0xbe, 0xa9, 0x93 }};
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPchResetCallbackProtocolGuid = {0x3a3300ab, 0xc929, 0x487d, {0xab, 0x34, 0x15, 0x9b, 0xc1, 0x35, 0x62, 0xc0}};
...
{
  return InstallPchReset (ImageHandle, SystemTable);
}
