...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE052D8A6, 0x224A, 0x4c32, {0x8D, 0x37, 0x2E, 0x0A, 0xE1, 0x62, 0x36, 0x4D}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PchSmbusDxe";
...
{
  return InitializePchSmbus (ImageHandle, SystemTable);
}
