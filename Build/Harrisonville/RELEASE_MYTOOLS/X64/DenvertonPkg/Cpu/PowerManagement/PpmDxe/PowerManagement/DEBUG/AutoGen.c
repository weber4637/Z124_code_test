...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x41E89AB0, 0xBD3D, 0x44b6, {0xA4, 0x31, 0xE4, 0x83, 0x6E, 0xFB, 0xF2, 0xCB}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PowerManagement2";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPowerManagementAcpiTableStorageGuid = {0x161be597, 0xe9c5, 0x49db, { 0xae, 0x50, 0xc4, 0x62, 0xab, 0x54, 0xee, 0xda}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPpmPlatformPolicyProtocolGuid = { 0xddabfeac, 0xef63, 0x452c, { 0x8f, 0x39, 0xed, 0x7f, 0xae, 0xd8, 0x26, 0x5e}};
...
{
  return InitializePowerManagement (ImageHandle, SystemTable);
}
