...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x326E9CC6, 0x9839, 0x4885, {0xB2, 0xED, 0x27, 0x59, 0x03, 0xB6, 0x68, 0xE1}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmmAccess";
...
{
  return SmmAccessDriverEntryPoint (ImageHandle, SystemTable);
}
