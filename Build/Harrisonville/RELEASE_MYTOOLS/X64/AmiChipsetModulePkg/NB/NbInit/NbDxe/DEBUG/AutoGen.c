...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE4ECD0B2, 0xE277, 0x4f2b, {0xBE, 0xCB, 0xE4, 0xD7, 0x5C, 0x9A, 0x81, 0x2E}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NbDxe";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiHobListGuid = { 0x7739F24C, 0x93D7, 0x11D4, { 0x9A, 0x3A, 0x00, 0x90, 0x27, 0x3F, 0xC1, 0x4D }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiSmbiosDynamicDataGuid = { 0xe380280c, 0x4c35, 0x4aa3, { 0xb9, 0x61, 0x7a, 0xe4, 0x89, 0xa2, 0xb9, 0x26 } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiMemoryInfoGuid = {0xa8f960c6, 0x4cc3, 0x4417,{0x8a, 0xd9, 0x2a, 0x3b, 0x3f, 0x80, 0x27, 0xea}};
...
{
  return NbDxeInit (ImageHandle, SystemTable);
}
