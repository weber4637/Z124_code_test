...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xD933DEDE, 0x0260, 0x4e76, {0xA7, 0xD9, 0x2F, 0x9F, 0x24, 0x40, 0xE5, 0xA5}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NbSmi";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitializeNbSmm (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
