...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xAA3C92A7, 0xDA1D, 0x472E, {0x9E, 0x3D, 0xED, 0xF0, 0x0D, 0xCF, 0x28, 0x87}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DigitalThermalSensor";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InstallDigitalThermalSensor (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
