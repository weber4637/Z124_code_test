...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC99E42D0, 0x4964, 0x4b09, {0xB9, 0x24, 0x4A, 0x59, 0xE1, 0x3E, 0x4F, 0x04}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SbRunSmm";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (SbRuntimeSmmInitEntryPoint (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
