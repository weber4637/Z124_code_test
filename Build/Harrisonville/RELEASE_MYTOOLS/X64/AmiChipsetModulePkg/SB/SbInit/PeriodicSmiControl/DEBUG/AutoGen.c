...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x87EA012D, 0xCBAD, 0x44c1, {0x84, 0x31, 0x61, 0x19, 0x3A, 0x06, 0x09, 0x41}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PeriodicSmiControl";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiPeriodicSmiControlProtocolGuid = { 0x801e9def, 0xddbb, 0x4ca3, { 0x96, 0x98, 0xc9, 0x15, 0x8e, 0xb8, 0x6a, 0xea } };
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitPeriodicSmiControl (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
