...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6298FE18, 0xD5EF, 0x42b7, {0xBB, 0x0C, 0x29, 0x53, 0x28, 0x3F, 0x57, 0x04}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SleepSmi";
  ...
  )
{
  ...
  if (SetJump (&mJumpContext) == 0) {
    ExitDriver (InitSleepSmi (ImageHandle, SystemTable));
    ASSERT (FALSE);
  }
