...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xB7D19491, 0xE55A, 0x470d, {0x85, 0x08, 0x85, 0xA5, 0xDF, 0xA4, 0x19, 0x74}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SbDxe";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiHobListGuid = { 0x7739F24C, 0x93D7, 0x11D4, { 0x9A, 0x3A, 0x00, 0x90, 0x27, 0x3F, 0xC1, 0x4D }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gBdsConnectDriversProtocolGuid = { 0x3aa83745, 0x9454, 0x4f7a, { 0xa7, 0xc0, 0x90, 0xdb, 0xd0, 0x2f, 0xab, 0x8e }};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiSbHddPolicyProtocolGuid = {0x75CA7C9D, 0x502E, 0x468a, {0x9A, 0xAF, 0x7F, 0x2A, 0x29, 0xE6, 0xDB, 0xCF}};
...
{
  return SbDxeInit (ImageHandle, SystemTable);
}
