...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x1890592d, 0xf10b, 0x448f, {0x93, 0xd5, 0x91, 0xef, 0xbc, 0x76, 0x06, 0x30}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "LoadHob";
...
{
  return LoadHobPeimEntry (FileHandle, PeiServices);
}
