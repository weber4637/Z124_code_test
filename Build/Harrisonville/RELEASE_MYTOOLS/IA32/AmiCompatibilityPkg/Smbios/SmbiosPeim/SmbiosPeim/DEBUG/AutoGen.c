...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x968C1D9F, 0x80C4, 0x43b7, {0x8C, 0xAE, 0x66, 0x8A, 0xA5, 0x6C, 0x4E, 0x71}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SmbiosPeim";
...
{
  return SmbiosPeiEntryPoint (FileHandle, PeiServices);
}
