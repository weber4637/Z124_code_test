...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x67451698, 0x1825, 0x4AC5, {0x99, 0x9D, 0xF3, 0x50, 0xCC, 0x7D, 0x5D, 0x72}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CryptoPPI";
...
// PPIs
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiDigitalSignaturePPIGuid = { 0x86c29aa5, 0xdb0, 0x4343, { 0xbd, 0x52, 0x7a, 0x72, 0x9f, 0x37, 0xc9, 0x6d }};
...
{
  return CryptoPei_Init (FileHandle, PeiServices);
}
