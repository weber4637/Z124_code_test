...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xA8499E65, 0xA6F6, 0x48B0, {0x96, 0xDB, 0x45, 0xC2, 0x66, 0x03, 0x0D, 0x83}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SiInitPreMem";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPerfPchPrePolicyGuid = {0x3112356F, 0xCC77, 0x4E82, {0x86, 0xD5, 0x3E, 0x25, 0xEE, 0x81, 0x92, 0xA4}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPerfSiValidateGuid = {0x681F96E6, 0xF9CF, 0x464D, {0x97, 0x9A, 0xB1, 0x11, 0x33, 0xDE, 0x37, 0xA9}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPerfPchValidateGuid = {0xD0FF37D6, 0xA569, 0x4058, {0xB3, 0xDA, 0x29, 0x0B, 0x38, 0xC5, 0x32, 0x25}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPerfPchPreMemGuid = {0xBB73E2B1, 0xB9FD, 0x4A80, {0xB8, 0x1A, 0x52, 0x39, 0xE9, 0x4D, 0x06, 0x2E}};
...
{
  return SiInitPrePolicy (FileHandle, PeiServices);
}
