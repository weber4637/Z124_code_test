...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xba51887a, 0xbeb9, 0x45da, {0x8e, 0x37, 0x98, 0xa6, 0xb4, 0x6e, 0x7c, 0x58}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "IeHeciInit";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gIeHobGuid = { 0x081077fa, 0x577d, 0x43b8, {0xa8, 0xac, 0x9e, 0x0d, 0x31, 0x65, 0xf4, 0xee }};
...
// PPIs
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPeiIeHeciPpiGuid = { 0xbebfba1f, 0x965f, 0x4f87, { 0xad, 0x55, 0xa0, 0x0a, 0x54, 0x7b, 0xcf, 0x69 }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPeiIePlatformPolicyPpiGuid = { 0x8f685891, 0x4e6f, 0x445c, { 0xbb, 0x9e, 0xe5, 0x7a, 0x28, 0xfa, 0x53, 0xa0 }};
...
{
  return IeHeciPeimEntryPoint (FileHandle, PeiServices);
}
