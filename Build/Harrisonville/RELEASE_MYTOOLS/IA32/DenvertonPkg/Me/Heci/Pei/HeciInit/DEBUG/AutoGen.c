...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x4862aff3, 0x667c, 0x5458, {0xb2, 0x74, 0xa1, 0xc6, 0x2d, 0xf8, 0xba, 0x80}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "HeciInit";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPeiHeci2PpiGuid = { 0xEE0EA811, 0xFBD9, 0x4777, { 0xB9, 0x5A, 0xBA, 0x4F, 0x71, 0x10, 0x1F, 0x74 }};
...
{
  return HeciPeimEntryPoint (FileHandle, PeiServices);
}
