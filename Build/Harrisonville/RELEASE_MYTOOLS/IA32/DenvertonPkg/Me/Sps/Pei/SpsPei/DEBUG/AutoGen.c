...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x44640C32, 0x33D7, 0x4fb0, {0xB1, 0xF9, 0x6C, 0x7B, 0x23, 0x2E, 0x99, 0x4D}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SpsPei";
...
{
  return SpsPeiEntryPoint (FileHandle, PeiServices);
}
