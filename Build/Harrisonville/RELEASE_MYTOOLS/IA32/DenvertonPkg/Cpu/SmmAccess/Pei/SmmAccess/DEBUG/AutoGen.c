...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xB4E0CDFC, 0x30CD, 0x4b29, {0xA4, 0x45, 0xB0, 0xAA, 0x95, 0xA5, 0x32, 0xE4}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PeiSmmAccess";
...
{
  return SmmAccessDriverEntryPoint (FileHandle, PeiServices);
}
