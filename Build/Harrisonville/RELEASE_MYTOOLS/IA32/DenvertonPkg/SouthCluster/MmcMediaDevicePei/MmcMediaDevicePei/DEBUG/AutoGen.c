...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x856C6A10, 0xF3B8, 0x4c2e, {0xA2, 0x73, 0x78, 0x68, 0xC0, 0x9B, 0xE8, 0xEA}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gPeiSdhcPpiGuid = { 0xf4ef9d7a, 0x98c5, 0x4c1a, { 0xb4, 0xd9, 0xd8, 0xd8, 0x72, 0x65, 0xbe, 0xc }};
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdEmmcBaseAddress0 = _PCD_VALUE_PcdEmmcBaseAddress0;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdMmcSdMultiBlockSupport = _PCD_VALUE_PcdMmcSdMultiBlockSupport;
...
{
  return MmcMainEntryPoint (FileHandle, PeiServices);
}
