...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x79AA6086, 0x035A, 0x4ad9, {0xA8, 0x9A, 0xA6, 0xD5, 0xAA, 0x27, 0xF0, 0xE2}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NbPei";
...
// PPIs
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiPeiNbCustomPpiGuid = {0x584cc99f,0x4be8,0x43d1,{0xa4,0x5a,0x93,0x3d,0xc3,0x94,0x79,0xfc}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiPeiNbInitPolicyGuid = {0x9ce4d938,0x9c87,0x41d0,{0x9e,0x55,0x34,0x92,0x3f,0xaf,0x8b,0x4f}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiPeiPciTableInitPpiGuid = { 0x97f91e78, 0xea12, 0x4ea6, { 0xb7, 0xb3, 0x7b, 0x6, 0x78, 0xc2, 0x86, 0x73 }};
...
{
  return NbPeiInit (FileHandle, PeiServices);
}
