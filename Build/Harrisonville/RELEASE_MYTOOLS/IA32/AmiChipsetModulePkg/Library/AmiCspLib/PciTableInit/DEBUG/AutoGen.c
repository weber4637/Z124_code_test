...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xDEF30E37, 0x7AEC, 0x4f69, {0x91, 0xA2, 0xCF, 0x09, 0x9E, 0x27, 0x29, 0xF2}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "PciTableInit";
...
{
  return CspLibPeiInit (FileHandle, PeiServices);
}
