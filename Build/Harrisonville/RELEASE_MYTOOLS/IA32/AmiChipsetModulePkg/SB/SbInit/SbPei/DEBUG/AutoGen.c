...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xC1FBD624, 0x27EA, 0x40d1, {0xAA, 0x48, 0x94, 0xC3, 0xDC, 0x5C, 0x7E, 0x0D}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "SbPei";

// Guids
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiCmosBadHobGuid = {0x7e7369ce, 0x0188, 0x4183,{0x8c, 0x2d, 0xda, 0xf7, 0xb7, 0x30, 0xe4, 0x2b}};
...
{
  return SbPeiInit (FileHandle, PeiServices);
}
