...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xd62c96e9, 0xd7d7, 0x4d28, {0xb0, 0xf9, 0xbf, 0x2c, 0xa1, 0x51, 0xdd, 0xef}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "IePolicyInitPei";
...
{
  return IePolicyInitPeiEntryPoint (FileHandle, PeiServices);
}
