...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9B8251B2, 0x4DFE, 0x429a, {0x9B, 0x51, 0x3B, 0x3E, 0x9E, 0xF7, 0x65, 0x51}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "IPMIPlatformID";
...
{
  return IPMIPlatformID_entry (FileHandle, PeiServices);
}
