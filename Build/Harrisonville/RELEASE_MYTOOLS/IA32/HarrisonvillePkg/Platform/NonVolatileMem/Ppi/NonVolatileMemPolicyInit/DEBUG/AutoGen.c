...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xf8df0b07, 0x5a84, 0x48d1, {0xbe, 0x56, 0xc1, 0xbc, 0x48, 0x89, 0xc6, 0x73}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NonVolatileMemPolicyInit";
...
{
  return NonVolatileMemPolicyInitEntryPoint (FileHandle, PeiServices);
}
