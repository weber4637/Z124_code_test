...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x12C67BE1, 0xAD2E, 0x4f13, {0xA9, 0x5F, 0x6E, 0xDC, 0x2C, 0x43, 0x92, 0xDE}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MePolicyInitPei";
...
{
  return MePolicyInitPeiEntryPoint (FileHandle, PeiServices);
}
