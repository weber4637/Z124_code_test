...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x838DCF34, 0x907B, 0x4d55, {0x9A, 0x4B, 0xA0, 0xEF, 0x71, 0x67, 0xB5, 0xF4}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NvramPei";
...
{
  return PeiInitNvram (FileHandle, PeiServices);
}
