...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x9029F23E, 0xE1EE, 0x40d1, {0x93, 0x82, 0x36, 0xDD, 0x61, 0xA6, 0x3E, 0xAA}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "NCT6683DPeiInit";
...
{
  return NCT6683DPeiInitEntryPoint (FileHandle, PeiServices);
}
