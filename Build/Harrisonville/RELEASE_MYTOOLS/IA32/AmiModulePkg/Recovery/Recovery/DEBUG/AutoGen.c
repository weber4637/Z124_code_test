...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xdacf705c, 0x71df, 0x497d, {0xaa, 0xbe, 0x10, 0x18, 0x6b, 0x2e, 0x1d, 0xde}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Recovery";
...
{
  return RecoveryEntry (FileHandle, PeiServices);
}
