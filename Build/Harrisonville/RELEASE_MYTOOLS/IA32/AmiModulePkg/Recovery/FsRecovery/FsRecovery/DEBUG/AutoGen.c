...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x7ecd9c20, 0x68b9, 0x4a6f, {0xb5, 0x15, 0xd6, 0x4f, 0xf5, 0x00, 0xb1, 0x09}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "FsRecovery";
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdCdRecoverySupport = _PCD_VALUE_PcdCdRecoverySupport;
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdFatRecoverySupport = _PCD_VALUE_PcdFatRecoverySupport;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdRecoveryImageName[8] = {65, 77, 73, 46, 82, 79, 77, 0 };
...
{
  return FsRecoveryPeimEntry (FileHandle, PeiServices);
}
