...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x10c22623, 0xdb6f, 0x4721, {0xaa, 0x30, 0x4c, 0x12, 0xaf, 0x42, 0x30, 0xa7}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "IdeRecovery";
...
{
  return IdeRecoveryPeimEntry (FileHandle, PeiServices);
}
