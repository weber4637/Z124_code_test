...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x7EB7126D, 0xC45E, 0x4BD0, {0x93, 0x57, 0x7F, 0x50, 0x7C, 0x5C, 0x9C, 0xF9}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "RomLayoutPei";
...
{
  return RomLayoutPeiEntryPoint (FileHandle, PeiServices);
}
