...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE9312938, 0xE56B, 0x4614, {0xA2, 0x52, 0xCF, 0x7D, 0x2F, 0x37, 0x7E, 0x26}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "AmiTcgPlatformPeiBeforeMem";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID AmiMemoryAbsentOverrideGuid = { 0x9c109e5e, 0xbf38, 0x4a78, { 0x9c, 0xac, 0x43, 0xde, 0x7e, 0x72, 0x6f, 0x9e} };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiTcgMADriverGuid = { 0x92ba9255, 0x2819, 0x4479, { 0x86, 0x7a, 0x1c, 0x58, 0xf0, 0x72, 0xc5, 0xb2} };
...
{
  return AmiTcgPlatformPEI_EntryBeforeMem (FileHandle, PeiServices);
}
