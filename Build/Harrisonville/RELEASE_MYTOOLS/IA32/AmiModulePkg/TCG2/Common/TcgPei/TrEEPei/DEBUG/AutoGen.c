...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x961C19BE, 0xD1AC, 0x4ba7, {0x87, 0xAF, 0x4A, 0xE0, 0xF0, 0x9D, 0xF2, 0xA6}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TrEEPei";
...
{
  return TrEEPeiEntry (FileHandle, PeiServices);
}
