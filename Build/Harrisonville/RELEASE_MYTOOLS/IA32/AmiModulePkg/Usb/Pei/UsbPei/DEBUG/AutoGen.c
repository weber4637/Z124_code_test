...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x39E8CA1A, 0x7A69, 0x4a73, {0x83, 0x4A, 0xD0, 0x63, 0x81, 0x93, 0x32, 0x86}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "UsbPei";
...
{
  return UsbPeiEntryPoint (FileHandle, PeiServices);
}
