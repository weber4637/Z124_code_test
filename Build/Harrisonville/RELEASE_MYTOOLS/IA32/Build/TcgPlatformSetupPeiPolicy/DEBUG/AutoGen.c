...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x0FE9DA53, 0x043D, 0x4265, {0xA9, 0x4D, 0xFD, 0x77, 0xFE, 0xDE, 0x2E, 0xB4}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TcgPlatformSetupPeiPolicy";
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID TcgPeiPolicyHobGuid = { 0xe4d805d, 0x746c, 0x4ebc, { 0x87, 0x95, 0x31, 0xa2, 0x86, 0xcc, 0xa6, 0x20 } };
...
{
  return TcgPlatformSetupPeiPolicyEntryPoint (FileHandle, PeiServices);
}
