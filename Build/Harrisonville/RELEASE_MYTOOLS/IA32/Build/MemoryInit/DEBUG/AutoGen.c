...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xDD86C88B, 0xC71A, 0x4033, {0xA2, 0xF8, 0x32, 0x78, 0xAF, 0xA0, 0x96, 0x28}};
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiAcpiVariableGuid = {0xc020489e, 0x6db2, 0x4ef2, { 0x9a, 0xa5, 0xca, 0x6, 0xfc, 0x11, 0xd3, 0x6a } };
...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gEfiPeiBeforeMemoryDiscoveredPpiGuid = {0xC884CCCD, 0x2760, 0x400E, {0xAA, 0x9D, 0x6D, 0x1A, 0x92, 0x41, 0xD5, 0x39 }};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiPeiBeforeMrcGuid = {0x71a8917b, 0x891, 0x4e27, {0x8a, 0x73, 0xa9, 0xb3, 0x34, 0x84, 0x3, 0x93}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiPeiAfterMrcGuid = {0x64c96700, 0x6b4c, 0x480c, {0xa3, 0xe1, 0xb8, 0xbd, 0xe8, 0xf6, 0x2, 0xb2}};
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gAmiPeiEndOfMemDetectGuid = {0x633194be, 0x1697, 0x11e1, {0xb5, 0xf0, 0x2c, 0xb2, 0x48, 0x24, 0x01, 0x9b}};
...
{
  return PeimMemoryInit (FileHandle, PeiServices);
}
