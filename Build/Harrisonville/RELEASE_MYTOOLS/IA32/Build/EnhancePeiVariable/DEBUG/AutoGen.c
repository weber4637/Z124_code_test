...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE03E6451, 0x297A, 0x4FE9, {0xB1, 0xF7, 0x63, 0x9B, 0x70, 0x32, 0x7C, 0x52}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "EnhancePeiVariable";
...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPeimRevision = 0x0001000AU;
...
{
  return EnhancePeiVariableEntry (FileHandle, PeiServices);
}
