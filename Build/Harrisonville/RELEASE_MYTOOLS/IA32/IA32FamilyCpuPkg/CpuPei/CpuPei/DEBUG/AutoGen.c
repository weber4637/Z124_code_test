...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x01359D99, 0x9446, 0x456d, {0xAD, 0xA4, 0x50, 0xA7, 0x11, 0xC0, 0x3A, 0xDA}};
...
{
  return CpuPeimInit (FileHandle, PeiServices);
}
