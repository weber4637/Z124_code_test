  ...
  )
{
  ...
  // To solve CPP Check Error: Shifting 32-bit value by 32 bits is undefined behaviour
  ...
  )
{
  ...
  UINT16  WordOfStart;
  UINT16  WordOfCount;
// Denverton AptioV Override Start - EIP#500492
...
// Denverton AptioV Override End - EIP#500492
