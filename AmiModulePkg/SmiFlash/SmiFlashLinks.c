 ...
 *
 */
// Denverton AptioV override Start - EIP#457046
VOID*  SmiFlashBuffer = NULL;
// Denverton AptioV override End - EIP#457046
...
// Denverton AptioV override Start - EIP#457046
    ...
    *(UINT32*)&mSMIFlashSmi[5] = SW_SMI_IO_ADDRESS;     //EDX
	if (SmiFlashBuffer) *(UINT32*)&mSMIFlashSmi[15] = (UINT32)SmiFlashBuffer; //EBX
    else *(UINT32*)&mSMIFlashSmi[15] = (UINT32)&FuncBlock;                    //EBX
// Denverton AptioV override End - EIP#457046	
