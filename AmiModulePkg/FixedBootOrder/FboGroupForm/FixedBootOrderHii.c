...
{
    return (BOOLEAN)(0==MemCmp(Guid1,Guid2,sizeof(EFI_GUID)));
}
/**
    ...
    while (!Updated && Offset < PackageHeader.Length) {
        ...
        *TempBufferSize += IfrOpHdr->Length;
        ...
        case EFI_IFR_GUID_OP :
            ...
            if (!EfiCompareGuid ((UINT8*)&(((EFI_IFR_GUID *) IfrOpHdr)->Guid), (UINT8*)&mIfrVendorGuid)) {
                //
            ...
            if (Insert) {
                ...
                while (TRUE) {
                    ...
                    if (IfrOpHdr->OpCode == EFI_IFR_GUID_OP) {
                        ExtendOpCode = ((EFI_IFR_GUID_LABEL *) IfrOpHdr)->ExtendOpCode;
                        if (EfiCompareGuid ((UINT8*)&(((EFI_IFR_GUID *) IfrOpHdr)->Guid), (UINT8*)&mIfrVendorGuid) && ExtendOpCode == EFI_IFR_EXTEND_OP_LABEL) {
                            break;
                        }
                    }
                }
