...
{
    UINT8 StringPei[MAX_PEI_STRING_BUFFER_SIZE];
    AmiDebugServiceDebugPrintHelper(GetPeiServicesTablePointer(),StringPei,ErrorLevel,Format,VaListMarker);
}
...
{
    UINT8 StringPei[MAX_PEI_STRING_BUFFER_SIZE];
    AmiDebugServiceDebugAssertHelper(GetPeiServicesTablePointer(),StringPei,FileName,LineNumber,Description);
}
