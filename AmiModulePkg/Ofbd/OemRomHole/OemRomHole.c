    ...
    IN BOOLEAN IsAppend)
{
    ...
    RomHoleStructPtr = (OFBD_TC_50_RH_STRUCT *)((UINT8 *)pOFBDHdr + sizeof(OFBD_HDR) + sizeof(OFBD_EXT_HDR)); 
...
//
    ...
    // DO NOT MODIFY +>>>>
    // --------------------------------------------------------------------------------------------------
    RHPtr = (OFBD_TC_50_RH_STRUCT *)((UINT8 *)pOFBDHdr + sizeof(OFBD_HDR) + sizeof(OFBD_EXT_HDR));    
