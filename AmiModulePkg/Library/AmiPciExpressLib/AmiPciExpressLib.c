...
EFI_STATUS PcieInitLink(PCI_DEV_INFO 	*DnPort )
{
	...
	// To solve CPP Check Error: Uninitialized variable
    UINT16              mpl, l0 = 0, l1 = 0;//calculated link speed
...
//-------------------------
    ...
    PCI_TRACE((TRACE_PCI,"PciE: MaxPayloadOption=%x ExtTagFieldOption =%x RelaxedOrderingOption=%x,MaxReadRequestOption=%x:NoSnoopOption=%x\n",
