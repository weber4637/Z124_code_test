...
/** @file TcgPlatformpeipolicy
     Installs Tcg policy from setup variables in Pei
...
// Denverton AptioV override Start - EIP#531417
//#if (defined(TPM2_DISABLE_PLATFORM_HIERARCHY_RANDOMIZATION) && (TPM2_DISABLE_PLATFORM_HIERARCHY_RANDOMIZATION == 1))            
//      ConfigFlags->Reserved3              = TcgPolicyHob->ConfigInfo.PhRandomization;
// #endif
// #if (defined(EXPOSE_FORCE_TPM_ENABLE) && (EXPOSE_FORCE_TPM_ENABLE == 1))            
//       ConfigFlags->Reserved4              = TcgPolicyHob->ConfigInfo.ForceTpmEnable;
// #endif
// Denverton AptioV override End - EIP#531417
