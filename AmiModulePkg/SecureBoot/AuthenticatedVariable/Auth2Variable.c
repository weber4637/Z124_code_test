...
/*
 * TBD. add logic to block append/set of certificate(s) known to be blocked. 
 * A blocked cert list is loaded from a .ffs. The ffs is read once during Nvram init and preserved as a r-only var.
 */
    }
    return Status;
}
