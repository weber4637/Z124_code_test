...
Error_Devicepath:
    ...
    UpdateComParametersinNvram(ComPort);
    return Status;
}
...
)
{
    ...
    CreateSpcrAcpiTable(AcpiTableProtocol,
...
/**
    ...
    AcpiTableProtocol is installed.
...
)
{
    ...
    if (EFI_ERROR(Status)) {
        ...
        CreateSpcrAcpiTable(AcpiTableProtocol, &gSpcrInfo);
    }
