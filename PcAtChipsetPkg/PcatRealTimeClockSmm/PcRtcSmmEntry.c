/** @file
  Provides SMM Set/Get time operations.
  ...
  )
{
    ...
    gSmmRs->GetTime       = PcRtcEfiGetTime;
    gSmmRs->SetTime       = PcRtcEfiSetTime;
    gSmmRs->GetWakeupTime = PcRtcEfiGetWakeupTime;
    gSmmRs->SetWakeupTime = PcRtcEfiSetWakeupTime;
