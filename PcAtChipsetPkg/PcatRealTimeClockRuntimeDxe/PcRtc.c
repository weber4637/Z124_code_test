...
#include "PcRtc.h"
#include "Token.h"	// Denverton AptioV override - EIP#263420
  ...
  )
{
  ...
  //
  //  Denverton AptioV override Start- EIP#483356
  // Update the RegisterB variable also when register value is modified.
  RegisterB.Data = RTC_INIT_REGISTER_B | (RegisterB.Data & BIT5);
  RtcWrite (RTC_ADDRESS_REGISTER_B, RegisterB.Data);
  //  Denverton AptioV override End- EIP#483356
...
// Denverton AptioV override Start - EIP#263420
    Time.Day    = DEFAULT_DAY; //RTC_INIT_DAY;
    Time.Month  = DEFAULT_MONTH; //RTC_INIT_MONTH;
    Time.Year   = DEFAULT_YEAR; //RTC_INIT_YEAR;
  ...
  )
{
  ...
  //
  RtcWrite (RTC_ADDRESS_CENTURY, DecimalToBcd8 ((UINT8) (RtcTime.Year / 100)));
  ...
  )
{
  ...
  RTC_REGISTER_D        RegisterD; // Denverton AptioV override  - EIP#256053
  ...
  if (Enable) {
    ...
    RegisterD.Bits.Reserved = RtcTime.Day;
    RtcWrite (RTC_ADDRESS_REGISTER_D, RegisterD.Data);
    // Denverton AptioV override end - EIP#256053
  ...
  )
{
  ...
  //
  // Denverton_AptioV_override_Start - EIP#577248
#if 0
  ...
  // Added below changes to calculate Century properly
 
      Century = CheckAndConvertBcd8ToDecimal8 (RtcRead (ACPI_CENTURY_CMOS));
  // Denverton_AptioV_override_End - EIP#577248
