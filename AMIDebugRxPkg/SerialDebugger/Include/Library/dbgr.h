...
INTN  DbgSingleLineAsmHandler(VOID *);
INTN  DbgCpuInfoSingleRegHandler(VOID *);
INTN DbgGetNvramAddr(VOID*);
INTN IsSysInSMM(VOID*);
INTN ReadSMMOutsideContext(VOID*);
INTN WriteSMMOutsideContext(VOID*);
...
// Single line Assembly execution
void DbgExecInvd(void); 
void DbgExecWbInvd(void); 

// Register wise CPU Info value
void GetCPUInfoSingleReg(UINT32, UINT32, UINT32*); 
